 ...
 *------------------------------------------*/
int storage_additem(struct map_session_data* sd, struct storage_data *stor, struct item* item_data, int amount)
{
 ...
 *   1 : success
 *------------------------------------------*/
int storage_add_to_inventory(struct map_session_data* sd, struct storage_data *stor, int index, int amount)
{
	int flag;
	struct item *it = NULL;
 ...
 *   1 : success
 *------------------------------------------*/
int storage_storagegettocart(struct map_session_data* sd, struct storage_data *stor, int index, int amount)
{
	int flag = 0;
	struct item *it = NULL;
 ...
 */
void storage_config_read_additional_fields(struct config_setting_t *t, struct storage_settings *s_conf, const char *filename)
{
...
void do_init_storage(bool minimal)
{
	if (minimal)
		return;
}
