...
// changed packet sizes
	...
	packet(0x0a97,clif->pEquipSwitchAdd);
	packet(0x0a99,clif->pEquipSwitchRemove);
	packet(0x0a9c,clif->pEquipSwitchRequest);
	...
	packet(0x0ace,clif->pEquipSwitchRequestSingle);
