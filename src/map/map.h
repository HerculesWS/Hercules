...
END_ZEROED_BLOCK;
	...
	uint32 (*vforeachinrange) (int (*func)(struct block_list*,va_list), struct block_list* center, int16 range, int type, va_list ap);
	uint32 (*foreachinrange) (int (*func)(struct block_list*,va_list), struct block_list* center, int16 range, int type, ...);
	uint32 (*vforeachinshootrange) (int (*func)(struct block_list*,va_list), struct block_list* center, int16 range, int type, va_list ap);
	uint32 (*foreachinshootrange) (int (*func)(struct block_list*,va_list), struct block_list* center, int16 range, int type, ...);
	uint32 (*vforeachinarea) (int (*func)(struct block_list*,va_list), int16 m, int16 x0, int16 y0, int16 x1, int16 y1, int type, va_list ap);
	uint32 (*foreachinarea) (int (*func)(struct block_list*,va_list), int16 m, int16 x0, int16 y0, int16 x1, int16 y1, int type, ...);
	uint32 (*vforcountinrange) (int (*func)(struct block_list*,va_list), struct block_list* center, int16 range, uint32 count, int type, va_list ap);
	uint32 (*forcountinrange) (int (*func)(struct block_list*,va_list), struct block_list* center, int16 range, uint32 count, int type, ...);
	uint32 (*vforcountinarea) (int (*func)(struct block_list*,va_list), int16 m, int16 x0, int16 y0, int16 x1, int16 y1, uint32 count, int type, va_list ap);
	uint32 (*forcountinarea) (int (*func)(struct block_list*,va_list), int16 m, int16 x0, int16 y0, int16 x1, int16 y1, uint32 count, int type, ...);
	uint32 (*vforeachinmovearea) (int (*func)(struct block_list*,va_list), struct block_list* center, int16 range, int16 dx, int16 dy, int type, va_list ap);
	uint32 (*foreachinmovearea) (int (*func)(struct block_list*,va_list), struct block_list* center, int16 range, int16 dx, int16 dy, int type, ...);
	uint32 (*vforeachincell) (int (*func)(struct block_list*,va_list), int16 m, int16 x, int16 y, int type, va_list ap);
	uint32 (*foreachincell) (int (*func)(struct block_list*,va_list), int16 m, int16 x, int16 y, int type, ...);
	uint32 (*vforeachinpath) (int (*func)(struct block_list*,va_list), int16 m, int16 x0, int16 y0, int16 x1, int16 y1, int16 range, int length, int type, va_list ap);
	uint32 (*foreachinpath) (int (*func)(struct block_list*,va_list), int16 m, int16 x0, int16 y0, int16 x1, int16 y1, int16 range, int length, int type, ...);
	uint32 (*vforeachinmap) (int (*func)(struct block_list*,va_list), int16 m, int type, va_list args);
	uint32 (*foreachinmap) (int (*func)(struct block_list*,va_list), int16 m, int type, ...);
	uint32 (*forcountinmap) (int (*func)(struct block_list*,va_list), int16 m, uint32 count, int type, ...);
	uint32 (*vforeachininstance)(int (*func)(struct block_list*,va_list), int16 instance_id, int type, va_list ap);
	uint32 (*foreachininstance)(int (*func)(struct block_list*,va_list), int16 instance_id, int type,...);
