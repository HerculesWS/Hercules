...
enum status_point_types { //we better clean up this enum and change it name [Hemagx]
	...
	// 4th job update
	SP_POW=219, SP_STA, SP_WIS, SP_SPL, SP_CON, SP_CRT, SP_PATK, SP_SMATK, SP_RES,  // 219-227
	SP_MRES, SP_HPLUS, SP_CRATE, SP_TSTATUSPOINT, SP_AP, SP_MAXAP,  // 228 - 233
