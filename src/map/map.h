...
enum E_MAPSERVER_ST { MAPSERVER_ST_RUNNING = CORE_ST_LAST, MAPSERVER_ST_SHUTDOWN, MAPSERVER_ST_LAST };
...
enum { RC2_NONE = 0, RC2_GOBLIN, RC2_KOBOLD, RC2_ORC, RC2_GOLEM, RC2_GUARDIAN, RC2_NINJA, RC2_SCARABA, RC2_TURTLE, RC2_MAX };
...
struct mapcell {
	...
	// dynamic flags
	unsigned char npc : 1, basilica : 1, landprotector : 1, novending : 1, nochat : 1, icewall : 1, noicewall : 1, noskill : 1;
 ...
 **/
enum say_dialog_align { DIALOG_ALIGN_LEFT = 0, DIALOG_ALIGN_RIGHT = 1, DIALOG_ALIGN_CENTER = 2, DIALOG_ALIGN_TOP = 3, DIALOG_ALIGN_MIDDLE = 4, DIALOG_ALIGN_BOTTOM = 5 };
 ...
 */
#define BL_CAST(type_, bl) (((bl) == (struct block_list *)NULL || (bl)->type != (type_)) ? (T##type_ *)NULL : (T##type_ *)(bl))
 ...
 * @retval NULL if bl is the wrong type or NULL.
 */
#define BL_CCAST(type_, bl) (((bl) == (const struct block_list *)NULL || (bl)->type != (type_)) ? (const T##type_ *)NULL : (const T##type_ *)(bl))
 ...
 * @return The block list, cast to the correct type.
 */
#define BL_UCAST(type_, bl) ((T##type_ *)BL_UCAST_(bl))
 ...
 * @return The block list, cast to the correct type.
 */
#define BL_UCCAST(type_, bl) ((const T##type_ *)BL_UCCAST_(bl))
