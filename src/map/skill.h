...
struct skill_interface {
	...
	int (*validate_skilltype) (const char *name, bool type, struct s_skill_db *skill);
	int (*validate_skillinfo) (const char *name, bool type, struct s_skill_db *skill);
	int (*validate_damagetype) (const char *name, bool type, struct s_skill_db *skill);
	int (*validate_castnodex) (const char *name, bool type, int *nodex);
	int (*validate_weapontype) (const char *name, bool type,  struct s_skill_db *skill);
	int (*validate_ammotype) (const char *name, bool type,  struct s_skill_db *skill);
	int (*validate_unit_flag) (const char *name, bool type,  struct s_skill_db *skill);
