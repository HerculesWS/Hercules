...
struct skill_interface {
	...
	int (*get_inf) (struct block_list *bl, int skill_id);
	int (*get_ele) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_nk) (struct block_list *bl, int skill_id);
	int (*get_max) (struct block_list *bl, int skill_id);
	...
	int (*get_hp) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_mhp) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_msp) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_sp) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_hp_rate) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_sp_rate) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_state) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_spiritball) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_item_index) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_itemid) (struct block_list *bl, int skill_id, int item_idx);
	int (*get_itemqty) (struct block_list *bl, int skill_id, int item_idx, int skill_lv);
	bool (*get_item_any_flag) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_equip_id) (struct block_list *bl, int skill_id, int item_idx);
	int (*get_equip_amount) (struct block_list *bl, int skill_id, int item_idx, int skill_lv);
	bool (*get_equip_any_flag) (struct block_list *bl, int skill_id, int skill_lv);
	...
	int (*get_walkdelay) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_time) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_time2) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_castnodex) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_delaynodex) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_castdef) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_weapontype) (struct block_list *bl, int skill_id);
	int (*get_ammotype) (struct block_list *bl, int skill_id);
	int (*get_ammo_qty) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_unit_id) (struct block_list *bl, int skill_id, int skill_lv, int flag);
	int (*get_inf2) (struct block_list *bl, int skill_id);
	int (*get_castcancel) (struct block_list *bl, int skill_id, int skill_lv);
	...
	int (*get_unit_flag) (struct block_list *bl, int skill_id);
	int (*get_unit_target) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_unit_interval) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_unit_bl_target) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_unit_layout_type) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_unit_range) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_cooldown) (struct block_list *bl, int skill_id, int skill_lv);
	int (*tree_get_max) (int skill_id, int class_);
	const char *(*get_name) (struct block_list *bl, int skill_id);
	const char *(*get_desc) (struct block_list *bl, int skill_id);
	/* whether its CAST_GROUND, CAST_DAMAGE or CAST_NODAMAGE */
	int (*get_casttype) (struct block_list *bl, int skill_id);
	int (*get_casttype2) (int index);
	sc_type (*get_sc_type) (struct block_list *bl, int skill_id);
	...
	int (*get_fixed_cast) (struct block_list *bl, int skill_id, int skill_lv);
	...
	int (*get_elemental_type) (struct block_list *bl, uint16 skill_id, uint16 skill_lv);
