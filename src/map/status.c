...
#ifdef RENEWAL_ASPD
	libconfig->format_db_path("re/job_db.conf", config_filename, sizeof(config_filename));
#else
	libconfig->format_db_path("pre-re/job_db.conf", config_filename, sizeof(config_filename));
#endif
