...
struct intif_interface {
	...
	void (*final)(void);
	int (*parse)(int fd);
	int (*create_pet)(int account_id, int char_id, int pet_type, int pet_lv, int pet_egg_id, int pet_equip, short intimate, short hungry, char rename_flag, char incubate, char *pet_name);
