...
#define itemid_is_sling_atk(n)   ( (n) >= ITEMID_APPLE_BOMB && (n) <= ITEMID_VERY_HARD_DARK_LUMP )
#define itemid_is_sling_buff(n)  ( (n) >= ITEMID_MYSTERIOUS_POWDER && (n) <= ITEMID_THROW_OVERDONE_FOOD )
