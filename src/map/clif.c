 ...
 */
void clif_achievement_send_list(int fd, struct map_session_data *sd)
{
#if PACKETVER >= 20141016
 ...
 */
void clif_parse_achievement_get_reward(int fd, struct map_session_data *sd) __attribute__((nonnull(2)));
void clif_parse_achievement_get_reward(int fd, struct map_session_data *sd)
{
#if PACKETVER >= 20141016
 ...
 */
void clif_parse_change_title(int fd, struct map_session_data *sd) __attribute__((nonnull(2)));
 ...
 */
void clif_change_title_ack(int fd, struct map_session_data *sd, int title_id)
{
#if PACKETVER >= 20141016
