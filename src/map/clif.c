		...
		case BL_PC:
			{
				...
				if(!battle_config.bg_eamod_mode && sd->bg_id && map->list[sd->bl.m].flag.battleground )
		...
		case BL_PC:
			{
				...
				if( !battle_config.bg_eamod_mode && tsd->bg_id && map->list[tsd->bl.m].flag.battleground )
