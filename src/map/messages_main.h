...
-> MAPNAME location (100 90), Scroll | Zeny | Plane (1: Enable or 0: Disable)
20211201 to latest
-> 맵이름, 위치(100/100), scroll/zeny/plane (1:사용함 0: 사용안함)
*/
...
-> When button is clicked, it will point you towards your destination if available
20211201 to latest
4.scroll/ zeny/ plane 상자를 원하는 만큼 체크하여 더 빠른 경로를 안내 받을 수 있다.
*/
...
1) /Navigation or /navi ex) /navi prontera 100 100 -> /navi "MAPNAME", 100, 100
20211201 to latest
/navigation2  /navi2 :  /navi2 yuno 100/100 1/1/1 ->> 맵이름, 위치(100/100), scroll/zeny/plane (1:사용함 0: 사용안함)
*/
...
20220720 to latest
 %d시간 %.2d분간 몬스터 사냥을 통해 얻을 수 있는 기본 아이템의 드롭률이 %d%%로 증가합니다.
*/
...
*/
	MSG_RESULT_ALREADY_LOSING_IDX = 0xa8c,
/*20141001 to latest
답장쓰기
Replying
*/
	MSG_RODEX_FOWARD = 0xa8d,
/*20141001 to latest
내용읽기
Read more
*/
	MSG_RODEX_READ = 0xa8e,
/*20141001 to latest
메일삭제
Delete message
*/
	MSG_RODEX_DELETE = 0xa8f,
/*20141001 to latest
仙貝 : %d
Crackers  : %d
*/
	MSG_TAIWAN_CASH_MSG_1 = 0xa90,
/*20141001 to latest
%s %s 仙貝
%s %s crackers 
*/
	MSG_TAIWAN_CASH_MSG_2 = 0xa91,
/*20141001 to latest
仙貝
Crackers 
*/
	MSG_TAIWAN_CASH_MSG_3 = 0xa92,
/*20141001 to latest
Total : %d 仙貝
Total : %d Crackers 
*/
	MSG_TAIWAN_CASH_MSG_4 = 0xa93,
/*20141001 to latest
%d -> %s 仙貝
%d -> %s Crackers 
*/
	MSG_TAIWAN_CASH_MSG_5 = 0xa94,
/*20141001 to latest
%s 仙貝
%s Crackers 
*/
	MSG_TAIWAN_CASH_MSG_6 = 0xa95,
/*20141001 to latest
                                          Current 仙貝 : %s
                                          Current Crackers : %s
*/
	MSG_TAIWAN_CASH_MSG_7 = 0xa96,
/*20141001 to latest
    %s  :  %s  仙貝
    %s  :  %s  Crackers
*/
	MSG_TAIWAN_CASH_MSG_8 = 0xa97,
/*20141001 to latest
%10s 仙貝
%10s Crackers
*/
	MSG_TAIWAN_CASH_MSG_9 = 0xa98,
/*20141001 to latest
Total : %s 仙貝
Total : %s Crackers
*/
	MSG_TAIWAN_CASH_MSG_10 = 0xa99,
/*20141001 to latest
※수수료 3% / 최소 1仙貝의 수수료 차감 
* Commission 3% / Minimum 1 Crackers comission deducted
*/
	MSG_TAIWAN_CASH_MSG_11 = 0xa9a,
/*20141001 to latest
仙貝 입니다.
The Crackers.
*/
	MSG_TAIWAN_CASH_ITEM_BAY_MAG2 = 0xa9b,
/*20141001 to latest
^0000ff仙貝 이상^000000입니다.
입력금액이 맞습니까?
^0000ff more than crackers^000000Did you enter the correct amount?
*/
	MSG_TAIWAN_CASH_WARNING_PRICE6 = 0xa9c,
/*20141001 to latest
10억仙貝이상 안전 확인
Over than 10billions secure check
*/
	MSG_TAIWAN_CASH_WARNING_PRICE7 = 0xa9d,
/*20141001 to latest
10억 仙貝 이상 입력하셔도 가격은 10억 仙貝로 판매됩니다.
If you fill over 1 billion, the price will be automatically set as 10 billion Xianbei.
*/
	MSG_TAIWAN_CASH_OVERPRICE_MAX = 0xa9e,
/*20141001 to latest
9,999仙貝 이상 입력하셔도 가격은 9,999仙貝로 판매됩니다.
If you fill over 9,999 Xianbei, the price will automatically set as 9,999 Xianbei.
*/
	MSG_TAIWAN_CASH_OVERPRICE9999 = 0xa9f,
/*20141001 to latest
가격이 0 仙貝인 아이템이 존재 합니다. 상점을 열수 없습니다!
There are items priced 0 Xianbei. You cannot open vending.
*/
	MSG_TAIWAN_CASH_YOU_HAVE_FREE_ITEM_ON_SHOP = 0xaa0,
/*20141001 to latest
상대 캐릭터가 최대 보유 仙貝량을 초과하여 거래가 불가능 합니다.
The opponent is over the Xianbei limit. Trade failed.
*/
	MSG_TAIWAN_CASH_MCSTORE_FAIL_SELLER_MONEY_GIVE = 0xaa1,
/*20141001 to latest
%s 아이템의 가격을 10억仙貝 이하로 입력해 주세요.
Please fill out %s item price less than 1 billion Xianbei.
*/
	MSG_TAIWAN_CASH_BUYINGSTORE_MAKEWND_REINPUTPRICE = 0xaa2,
/*20141001 to latest
%s  :  %s  仙貝 => %s EA
%s:  %s  Xianbei => %s ea
*/
	MSG_TAIWAN_CASH_BUYINGSTORE_MAKEWND_ITEMLIST = 0xaa3,
/*20141001 to latest
제한 금액 : %s 仙貝
Limited price: %s Xianbei
*/
	MSG_TAIWAN_CASH_BUYINGSTORE_MYSHOPWND_LIMITZENY = 0xaa4,
/*20141001 to latest
%s %s 仙貝 %d 개
%s %s %d Xianbei
*/
	MSG_TAIWAN_CASH_BUYINGSTORE_MYSHOPWND_ITEMINFO = 0xaa5,
/*20141001 to latest
%s %d개를 %d 仙貝에 판매 하였습니다. 수수료는 3%% 입니다.
%d %s are sold. In total %d Xianbei. 3%% charge will be imposed.
*/
	MSG_TAIWAN_CASH_BUYINGSTORE_TRADE_SELLCOMPLETE = 0xaa6,
#endif
...
SEND
*/
	MSG_RODEX_SEND_WND = 0xaa8,
/*20141008 to latest
RECEIVE
*/
	MSG_RODEX_RECEIVE_WND = 0xaa9,
#endif
...
*/
	MSG_RODEX_CHOOSEWND_FAILED = 0xaaa,
#endif
...
*/
	MSG_ACCESS_DENIED_BY_AUTHSERVER_CONNECTION = 0xaab,
/*20141022 to latest
서버접근거부(B)
Server access denied(B)
*/
	MSG_ACCESS_DENIED_BY_BILLSERVER_CONNECTION = 0xaac,
#endif
...
*/
	MSG_FAILIED_ONECLICK_ITEMIDENTIFY_NO_MAGNIFIER = 0xaaf,
#endif
...
*/
	MSG_FAILED_UNLOCK_ITEM_DROP_IN_COMPOSE_WND = 0xab0,
/*20141210 to latest
상대방이 친구 요청중입니다
The opponent has already requested you to be a friend.
*/
	MSG_FAILED_FRIEND_ADD__ALREADY_REQUEST = 0xab1,
#endif
#if PACKETVER >= 20141217
/*20141217 to latest
SCRIPT ERROR AID
*/
	MSG_UISCRIPT_ERROR_GUIDE = 0xab2,
...
ErrorContext: %s
*/
	MSG_UISCRIPT_ERROR_GUIDE_MSG = 0xab3,
#endif
...
*/
	MSG_TAIWAN_CASH_BUY_RECONFIRM = 0xab4,
/*20141224 to latest
닫기
Close
*/
	MSG_MINIMAP_MSG_01 = 0xab5,
/*20141224 to latest
퀘스트
Quest
*/
	MSG_MINIMAP_MSG_02 = 0xab6,
/*20141224 to latest
퀘스트 아이콘 보기
View Quest icon
*/
	MSG_MINIMAP_MSG_03 = 0xab7,
/*20141224 to latest
편의시설
Facility
*/
	MSG_MINIMAP_MSG_04 = 0xab8,
/*20141224 to latest
편의시설 아이콘 보기
View Facility icon
*/
	MSG_MINIMAP_MSG_05 = 0xab9,
/*20141224 to latest
길드원/파티원
Guild/Party
*/
	MSG_MINIMAP_MSG_06 = 0xaba,
...
Show Guild/Party
*/
	MSG_MINIMAP_MSG_07 = 0xabb,
/*20141224 to latest
기록하기
Record
*/
	MSG_MINIMAP_MSG_08 = 0xabc,
/*20141224 to latest
보스몬스터
Boss Monster
*/
	MSG_MINIMAP_MSG_09 = 0xabd,
/*20141224 to latest
나
I
*/
	MSG_MINIMAP_MSG_10 = 0xabe,
/*20141224 to latest
삭제 하시겠습니까?
Are you sure want to delete it?
*/
	MSG_MINIMAP_MSG_11 = 0xabf,
/*20141224 to latest
퀘스트 NPC
Quest NPC
*/
	MSG_MINIMAP_MSG_12 = 0xac0,
/*20141224 to latest
메모할 내용을 기록합니다
Record content
*/
	MSG_MINIMAP_MSG_13 = 0xac1,
/*20141224 to latest
저장하기
Store
*/
	MSG_MINIMAP_MSG_14 = 0xac2,
/*20141224 to latest
메모하기
Record
*/
	MSG_MINIMAP_MSG_15 = 0xac3,
#endif
...
*/
	MSG_TAIWAN_CASH_LEMITEMIN = 0xaca,
#endif
...
Hair color
*/
	MSG_DRESSROOM_HEARCOLOR = 0xacb,
/*20150114 to latest
머리 모양
Hair style
*/
	MSG_DRESSROOM_HEARSTYLE = 0xacc,
/*20150114 to latest
옷 색
Cloth color
*/
	MSG_DRESSROOM_BODYCOLOR = 0xacd,
/*20150114 to latest
옷 모양
Cloth pattern
*/
	MSG_DRESSROOM_BODYSTYLE = 0xace,
#endif
...
*/
	MSG_BANK_MAX_MONEY = 0xad0,
/*20150304 to latest
1 Zeny 이상 입력 하십시오.
Please Enter atleast 1 zeny.
*/
	MSG_BANK_MIN_MONEY = 0xad1,
/*20150304 to latest
보유한 Zeny 가 없습니다.
You do not hold any zeny.
*/
	MSG_BANK_0_MONEY = 0xad2,
/*20150304 to latest
제니 창고
Zeny Storage
*/
...
*/
	MSG_BANK_NOMSG = 0xadb,
/*20150304 to latest
보유 Zeny 부족
Not enough zeny
*/
	MSG_BANK_0_MINI = 0xadc,
/*20150304 to latest
입력값 필요
Input Required
*/
	MSG_BANK_1_MINI = 0xadd,
/*20150304 to latest
문자 입력 불가
Numbers only
*/
	MSG_BANK_2_MINI = 0xade,
/*20150304 to latest
최대 입력 초과
Exceeded max input
*/
	MSG_BANK_3_MINI = 0xadf,
/*20150304 to latest
최소 입력 미만
Below Minimum Input
*/
	MSG_BANK_4_MINI = 0xae0,
/*20150304 to latest
보유 Zeny 부족
Not enough zeny
*/
	MSG_BANK_5_MINI = 0xae1,
/*20150304 to latest
은행 잔고 부족
Insufficient funds
*/
	MSG_BANK_6_MINI = 0xae2,
/*20150304 to latest
최대 보유 Zeny 초과
Exceeded max zeny
*/
	MSG_BANK_7_MINI = 0xae3,
#endif
...
Drop X
*/
	MSG_ITEMMOVEINFO_DROP = 0xae4,
/*20150311 to latest
창고 X
Storage X
*/
	MSG_ITEMMOVEINFO_STORE = 0xae5,
/*20150311 to latest
카트 X
Cart X
*/
	MSG_ITEMMOVEINFO_CART = 0xae6,
/*20150311 to latest
메일 X
Mail X
*/
	MSG_ITEMMOVEINFO_MAIL = 0xae7,
/*20150311 to latest
교환창 X
Trade X
*/
	MSG_ITEMMOVEINFO_EXCHANGEWND = 0xae8,
/*20150311 to latest
경매장 X
Auction X
*/
	MSG_ITEMMOVEINFO_AUCTION = 0xae9,
/*20150311 to latest
길드창고 X
Guild Storage X
*/
	MSG_ITEMMOVEINFO_STOREOFGUILD = 0xaea,
/*20150311 to latest
NPC에게 판매 X
Sell to NPC X
*/
	MSG_ITEMMOVEINFO_TONPC = 0xaeb,
/*20150311 to latest
이동제한이 있는 아이템입니다.
Item moves restriction.
*/
	MSG_ITEMMOVEINFO_BTN = 0xaec,
#endif
...
Flicker Effect ON
*/
	MSG_QUAKE_EFFECT_ON = 0xaf5,
/*20150701 to latest
화면 흔들림 효과 OFF
Flicker Effect OFF
*/
	MSG_QUAKE_EFFECT_OFF = 0xaf6,
#endif
...
*/
	MSG_NOT_USING_TAG_TO_NAME = 0xafc,
#endif
...
*/
	MSG_STYLING_SHOP_NEED_COUPON = 0xafe,
/*20151028 to 20151125
아이템창의 쿠폰 상자를 열어주세요
20151202 to latest
...
*/
	MSG_STYLING_SHOP_OPEN_COUPON = 0xaff,
/*20151028 to 20151125
은행
Bank
20151202 to latest
...
Bank
*/
	MSG_STYLING_SHOP_DELETE_CHAR = 0xb00,
/*20151028 to 20151125
...
*/
	MSG_STYLING_SHOP_FAIL_TO_ADD_CHAR_TO_LIKE = 0xb01,
/*20151028 to 20151125
...
*/
	MSG_STYLING_SHOP_ADJUST_NEW_CHAR_STYLE = 0xb02,
#endif
...
*/
	MSG_STYLING_SHOP_REGISTER_BOOKMARK = 0xb03,
/*20151104 to 20151125
...
*/
	MSG_STYLING_SHOP_SUGGEST_TO_GO_TO_BANK = 0xb04,
#endif
...
Accessory
*/
	MSG_STYLING_SHOP_ACCESSORYWND = 0xb0f,
/*20151125 to latest
세컨드코스튬
Second costume
*/
	MSG_STYLING_SHOP_2NDCOSTUMEWND = 0xb10,
/*20151125 to 20151125
즐겨찾기
20151202 to latest
내 스타일 
Wardrobe
*/
	MSG_STYLING_SHOP_LIKELISTWND = 0xb11,
/*20151125 to 20151125
염색을 할 수 없는 머리스타일입니다.
20151202 to latest
염색할 수 없는 헤어스타일입니다.
...
*/
	MSG_STYLING_SHOP_IS_NOT_COLORING_HEAD = 0xb12,
/*20151125 to 20151125
...
*/
	MSG_STYLING_SHOP_OPENING_COMMENT = 0xb13,
#endif
...
*/
	MSG_STYLING_SHOP_SUCCESS = 0xb14,
#endif
...
Basic style
*/
	MSG_STYLING_SHOP_BASICSTYLE = 0xb15,
#endif
...
*/
	MSG_UPGRADESKILLERROR_MORE_BASE_LEVEL = 0xb16,
#endif
...
Compare items
*/
	MSG_INVENTORY_ITEM_COMPARE = 0xb1a,
/*20160203 to latest
아이템 버리기 잠금
Drop lock
*/
	MSG_INVENTORY_ITEM_DROP_LOCK = 0xb1b,
#endif
...
*/
	MSG_NOT_ADDING_SCREENSHOT = 0xb1c,
...
Twitter
*/
	MSG_CONNECT_SNS_WND = 0xb1d,
/*20160224 to latest
일반
General
*/
	MSG_RODEX_GENERAL = 0xb1e,
/*20160224 to latest
공지
Notice
*/
	MSG_RODEX_NOTICE = 0xb1f,
/*20160224 to latest
반송
Clear
*/
	MSG_RODEX_RETURN = 0xb20,
/*20160224 to latest
새로고침
Refresh
*/
	MSG_RODEX_REFRESH = 0xb21,
/*20160224 to latest
%d분
%d minute
*/
	MSG_RODEX_DELETE_TIME_MINUTE = 0xb22,
/*20160224 to latest
%d시간
%d hour
*/
	MSG_RODEX_DELETE_TIME_HOUR = 0xb23,
/*20160224 to latest
%d일
%d day
*/
	MSG_RODEX_DELETE_TIME_DAY = 0xb24,
/*20160224 to latest
반송됨
Returned
*/
	MSG_RODEX_RETURNED = 0xb25,
/*20160224 to latest
선택한 메일을 삭제하시겠습니까?
Do you want to delete the message?
*/
	MSG_RODEX_DELETE_SELECT_MAIL = 0xb26,
#endif
...
Show information
*/
	MSG_MINIMAP_TIP_POS_ON = 0xb27,
/*20160302 to latest
확대
Zoom In
*/
	MSG_MINIMAP_TIP_ZOOM_IN = 0xb28,
/*20160302 to latest
축소
Zoom Out
*/
	MSG_MINIMAP_TIP_ZOOM_OUT = 0xb29,
/*20160302 to latest
맵보기
Maximize
*/
	MSG_MINIMAP_TIP_MAP_VIEW = 0xb2a,
/*20160302 to latest
월드보기
Show world map
*/
	MSG_MINIMAP_TIP_WORLD_VIEW = 0xb2b,
/*20160302 to latest
아이템 소지 종류수
Total possession item type
*/
	MSG_INVENTORY_NUMBER_OF_ITEM = 0xb2c,
#endif
#if PACKETVER >= 20160309
/*20160309 to latest
/minimap
*/
	MSG_MINIMAP_BUTTON_ONOFF = 0xb2d,
/*20160309 to latest
미니맵 버튼을 표시합니다
Show minimap buttons
*/
	MSG_MINIMAP_BUTTON_ON = 0xb2e,
/*20160309 to latest
미니맵 버튼을 표시하지 않습니다
Hide minimap buttons
*/
	MSG_MINIMAP_BUTTON_OFF = 0xb2f,
/*20160309 to latest
길드 접속자 정렬
Show guild member login status
*/
	MSG_GUILD_MEMBERLIST_SORT = 0xb30,
#endif
...
Intimacy: %s
*/
	MSG_WRITE_PET_RELATION_SHIP = 0xb31,
/*20160323 to latest
확인 전
Confirmation
*/
	MSG_PET_RELATION_SHIP_UNKNOWN = 0xb32,
#endif
...
*/
	MSG_WRITE_RODEX_DIFFERENT_RECEIVER_NAME = 0xb4f,
#endif
...
*/
	MSG_LAPINE_INGREDIENT_TO_COMBINE = 0xb50,
/*20160427 to latest
조합 재료가 부족해서 조합할 수 없습니다.
Insufficient synthesis materials
*/
	MSG_LAPINE_FAIL_NOT_ENOUGH_ITEM = 0xb51,
#endif
...
*/
	MSG_LAPINE_FAIL_NOT_ENOUGH_ITEM_COUNT = 0xb52,
/*20160504 to latest
제련도가 낮아서 조합할 수 없습니다.
Refine value is to low for synthesis
*/
	MSG_LAPINE_FAIL_NOT_ENOUGH_REFINING_LEVEL = 0xb53,
/*20160504 to latest
모험가중개소에 등록 하시겠습니까?
Do you want to sign in to the adventurers?
*/
	MSG_REGISTER_PARTY_TO_BOOKINGSYSTEM = 0xb54,
#endif
...
*/
	MSG_CAPTCHA_INPUT_ANSWER = 0xb56,
/*20160518 to latest
%d초 남았습니다
%d second left
*/
	MSG_CAPTCHA_REMAIN_TIME = 0xb57,
/*20160518 to latest
OTP 인증번호 6자리를 입력해 주세요
Please enter your 6 identification number.
*/
	MSG_GOOGLE_OTP_INPUT_CODE = 0xb58,
/*20160518 to latest
인증번호
Identification number.
*/
	MSG_GOOGLE_OTP_AUTH_CODE = 0xb59,
/*20160518 to latest
6자리의 숫자가 아닙니다. 다시 확인해 주세요
It's not a 6 identification number. Please try again
*/
	MSG_GOOGLE_OTP_MSG = 0xb5a,
#endif
...
*/
	MSG_SELECT_AREA_BY_PRIVATE_AIRPLANE = 0xb5c,
/*20160615 to latest
E X P : %d%% ( basic 100.0%% %s %d%%)
*/
	MSG_THAI_PERSONALINFO_EXP = 0xb5d,
/*20160615 to latest
DROP  : %d%% ( basic 100.0%% %s %d%%)
*/
	MSG_THAI_PERSONALINFO_DROP = 0xb5e,
/*20160615 to latest
DEATH : %d%% ( basic 100.0%% %s %d%%)
*/
	MSG_THAI_PERSONALINFO_DEATH = 0xb5f,
/*20160615 to latest
목적지로 이동중입니다.
Move to the destination
*/
	MSG_FLOATING_PRIVATE_AIRPLANE = 0xb60,
#endif
...
*/
	MSG_NOT_FOUND_USER_AI = 0xb61,
/*20160629 to 20160630
 %.1f%% ( Premium %.1f%% + %s %.1f%%)
20160706 to latest
 %.1f%% ( Basic 100.0%% + Premium %.1f%% + %s %.1f%%)
*/
	MSG_BASIC_EXP_MSG_BRZ2 = 0xb62,
#endif
...
*/
	MSG_ASSISTANT_VENDING_POS = 0xb63,
#endif
...
*/
	MSG_DORAM_CANT_EQUIT_THIS = 0xb64,
...
*/
	MSG_SEND_PURCHASES_BY_RODEX = 0xb65,
/*20160713 to latest
30,000 z
*/
	MSG_BUTTON_PAY_BY_ZENY = 0xb66,
/*20160713 to latest
말랑도 특산 통조림 100개
Malangdo Special Can 100 pc
*/
	MSG_BUTTON_PAY_BY_CAN = 0xb67,
#endif
...
*/
	MSG_CANNOT_ACCESS_BY_WEIGHTOVER_80 = 0xb68,
/*20160720 to latest
판매되지 못한 상품이 로덱스로 배송되었습니다.
Unsold items are sent to RODEX
*/
	MSG_SEND_REST_ITEMS_BY_RODEX = 0xb69,
#endif
...
Preview
*/
	MSG_BUTTON_EQUIP_PREVIEW = 0xb6a,
/*20160727 to latest
길드마스터 위임
Assign Guild Leader
*/
	MSG_CHANGE_GUILD_MASTER = 0xb6b,
/*20160727 to latest
...
Trade date : 
*/
	MSG_STORE_ASSISTANT_TRADE_DATE = 0xb74,
/*20160803 to 20160803
판매 아이템 : 
20160810 to latest
거래 아이템 : 
Trade item : 
*/
	MSG_STORE_ASSISTANT_TRADE_ITEM = 0xb75,
/*20160803 to 20160803
판매 수량 : 
20160810 to latest
거래 수량 : 
Trade quantity : 
*/
	MSG_STORE_ASSISTANT_TRADE_CNT = 0xb76,
/*20160803 to 20160803
판매 단가 : 
20160810 to latest
거래 단가 : 
Trade price : 
*/
	MSG_STORE_ASSISTANT_TRADE_PRICE = 0xb77,
/*20160803 to 20160803
판매 금액 : 
20160810 to latest
거래 금액 : 
Total trade : 
*/
	MSG_STORE_ASSISTANT_TRADE_PAYMENT = 0xb78,
/*20160803 to latest
노점 판매 아이템
Open vending sales agent
*/
	MSG_STORE_ASSISTANT_TRADE_TITLE1 = 0xb79,
/*20160803 to latest
노점 구매 아이템
Open vending purchase agent
*/
	MSG_STORE_ASSISTANT_TRADE_TITLE2 = 0xb7a,
/*20160803 to latest
판매 노점 아르바이트 종료
Close vending sales agent
*/
	MSG_STORE_ASSISTANT_TRADE_TITLE3 = 0xb7b,
/*20160803 to latest
구매 노점 아르바이트 종료
Close vending purchase agent
*/
	MSG_STORE_ASSISTANT_TRADE_TITLE4 = 0xb7c,
/*20160803 to latest
남은 금액:
Balance: 
*/
	MSG_STORE_ASSISTANT_TRADE_REST_ZENY = 0xb7d,
/*20160803 to latest
아이템 리스트:
Item list: 
*/
	MSG_STORE_ASSISTANT_TRADE_REST_ITEM = 0xb7e,
/*20160803 to latest
노점 아르바이트생
Vending agent
*/
	MSG_STORE_ASSISTANT_EMPLOYMENT = 0xb7f,
/*20160803 to latest
반환 아이템:
Returned item: 
*/
	MSG_STORE_ASSISTANT_RETURN_ITEM = 0xb80,
/*20160803 to latest
반환 수량:
Returned quantity: 
*/
	MSG_STORE_ASSISTANT_RETURN_CNT = 0xb81,
/*20160803 to latest
반환 일시:
Returned date: 
*/
	MSG_STORE_ASSISTANT_REUTRN_DATE = 0xb82,
/*20160803 to latest
구매 노점에서 거래한 금액이 로덱스로 배송되었습니다
Total trade will be sent to RODEX 
*/
	MSG_STORE_ASSISTANT_SEND_SELLS_BY_RODEX = 0xb83,
/*20160803 to latest
사용할 수 없는 이름입니다.
Name isn't available
*/
	MSG_CANNOT_USE_NAME = 0xb84,
#endif
...
*/
	MSG_STYLING_SHOP_ARRIVE_GOODS = 0xb85,
/*20160817 to latest
구입해주셔서 감사합니다.
Thank you for purchasing
*/
	MSG_STYLING_SHOP_THANK_YOU = 0xb86,
#endif
...
*/
	MSG_CANNOT_SELL_IN_PRIVATE_TAB = 0xb87,
/*20160824 to latest
아이템 판매 잠금
Lock from NPC selling
*/
	MSG_LOCK_SELL_IN_PRIVATE_TAB = 0xb88,
/*20160824 to latest
근처에서 소환가능 위치를 찾을수 없습니다.
There is no callable location nearby
*/
	MSG_NOTFOUND_CALLPOSITION = 0xb89,
/*20160824 to latest
전체 화면 캡쳐
Capture full screens
*/
	MSG_CONNECT_SNS_WHOLE_SCREEN_SHOT = 0xb8a,
/*20160824 to latest
부분 화면 캡쳐
Capture part of screen
*/
	MSG_CONNECT_SNS_PART_SCREEN_SHOT = 0xb8b,
/*20160824 to latest
보내기
Send
*/
	MSG_CONNECT_SNS_SEND = 0xb8c,
/*20160824 to latest
가족 분과 담당자
Family Affairs agent
*/
	MSG_BABY_INDEPENDENCE_RODEX_SENDER = 0xb8d,
/*20160824 to latest
가족 사항 변동 안내
Acknowledgement of family member registrations.
*/
	MSG_BABY_INDEPENDENCE_RODEX_TITLE = 0xb8e,
/*20160824 to latest
안녕하십니까.
...
Thank you.
*/
	MSG_BABY_INDEPENDENCE_RODEX_CONTENTS = 0xb8f,
#endif
...
No image
*/
	MSG_CONNECT_SNS_DO_NOT_EXIST_IMAGE = 0xb91,
#endif
...
*/
	MSG_USING_BLACKSMITH_BLESSING = 0xb97,
/*20160913 to latest
제니가 부족합니다.
Insufficient zeny
*/
	MSG_NOTENOUGH_ZENY = 0xb98,
/*20160913 to latest
대장장이의 축복 개수가 부족합니다.
Not enough Blacksmith's Blessing
*/
	MSG_NOTENOUGH_BLACKSMITH_BLESSING = 0xb99,
/*20160913 to latest
해당 장비는 제련이 불가능합니다.
This equipment can not be refined
*/
	MSG_CANNOT_REFINE_ITEM = 0xb9a,
...
With Mr/Miss
*/
	MSG_MANUFACTURED_MARRIAGERING_ITEM = 0xba0,
/*20160921 to latest
...
*/
	MSG_FAILED_PET_AUTO_FEEDING_CLOSE_RODEX = 0xba9,
/*20161005 to latest
장비 세트 설정
Set item setting
*/
	MSG_SWAP_EQUIPITEM_EQUIPMENTSET = 0xbaa,
/*20161005 to latest
장착 하기
Equip
*/
	MSG_SWAP_EQUIPITEM_EQUIP = 0xbab,
#endif
...
*/
	MSG_SWAP_EQUIPITEM_CLOSE_WND = 0xbc0,
#endif
...
*/
	MSG_SWAP_EQUIPITEM_FAIL_NO_ITEM = 0xbc1,
/*20161109 to latest
삭제된 캐릭터
Deleted character
*/
	MSG_BABY_INDEPENDENCE_RODEX_ERASED = 0xbc2,
#endif
#if PACKETVER >= 20161116
/*20161116 to latest
%Y.%m.%d
*/
	MSG_TIME_TYPE4 = 0xbc3,
/*20161116 to latest
접속일: %s
Access date: %s
*/
	MSG_LAST_LOGIN = 0xbc4,
/*20161116 to latest
제련 중에는 은행을 사용할 수 없습니다. 은행을 강제 종료하였습니다.
You can not use bank while refining. Bank has closed.
*/
	MSG_CLOSE_BANKING_FOR_REFINING = 0xbc5,
/*20161116 to latest
제련 중에는 은행을 사용할 수 없습니다.
You can not use bank while refining.
*/
	MSG_CANNOT_OPEN_BANKING_DURING_REFINING = 0xbc6,
/*20161116 to latest
장비 세트 설정 중인 아이템입니다.
The item has bind to set equipment.
*/
	MSG_SWAP_EQUIPITEM_UNREGISTER_FIRST = 0xbc7,
#endif
...
Human
*/
	MSG_NEWMAKECHAR_HUMAN = 0xbc8,
/*20161123 to latest
검사, 법사, 상인, 복사, 도둑, 궁수
Swordman, Mage, Merchant, Acolyte, Thief, Archer
*/
	MSG_NEWMAKECHAR_HUMANJOB = 0xbc9,
/*20161123 to latest
도람
Doram
*/
	MSG_NEWMAKECHAR_DORAM = 0xbca,
/*20161123 to latest
소환사
Summoner
*/
	MSG_NEWMAKECHAR_DORAMJOB = 0xbcb,
/*20161123 to latest
...
*/
	MSG_NEWMAKECHAR_HUMANINFO = 0xbcc,
/*20161123 to latest
...
*/
	MSG_NEWMAKECHAR_DORAMINFO = 0xbcd,
/*20161123 to latest
소지 한계량이 70%를 초과하거나, 인벤토리에 10칸 이상의 여유 공간이 부족한 상태입니다.
Weight limit has reached toover 70%. Or less then 10 invenrory space.
*/
	MSG_PICKUP_FAILED_ITEMCREATE = 0xbce,
/*20161123 to latest
C
EUR
*/
	MSG_CASH_MARK1 = 0xbcf,
/*20161123 to latest
C
EUR
*/
	MSG_CASH_MARK2 = 0xbd0,
/*20161123 to latest
다른 일을 하는 중입니다.
Doing in other activity.
*/
	MSG_ANOTHER_WORKING = 0xbd1,
/*20161123 to latest
오버히트 리미트 : %d
Overheat limit : %d
*/
	MSG_OVERHEAT_LIMIT_POINT = 0xbd2,
#endif
...
*/
	MSG_CANNOT_JOIN_AND_LEAVE_PARTY_IN_MAKING_MEMORIALDUNGEON = 0xbd3,
/*20161130 to latest
비속어가 포함되어있습니다.
다시 한번 확인해주세요.
...
Please check again.
*/
	MSG_ERROR_INCLUDE_VALGARISM = 0xbd4,
#endif
...
/300
*/
	MSG_DAILYSENDRODEXCNT_LIMIT = 0xbda,
/*20161214 to latest
/2000
/4000
*/
	MSG_MAX_WEIGHT_IN_RODEX_CLIENT = 0xbdb,
/*20161214 to latest
https://member.gnjoy.com.tw/mRO_SecPwd.aspx
*/
	MSG_TW_ENABLE_SECOND_PASSWD = 0xbdc,
/*20161214 to latest
...
Purchase 1x
*/
	MSG_ZENY_LOTTO_BUY_1 = 0xbe7,
/*20161228 to latest
10회 구매
Purchase 10x
*/
	MSG_ZENY_LOTTO_BUY_10 = 0xbe8,
/*20161228 to latest
100회 구매
Purchase 100x
*/
	MSG_ZENY_LOTTO_BUY_100 = 0xbe9,
/*20161228 to latest
1등 당첨
Win 1st prize
*/
	MSG_ZENY_LOTTO_WIN_1ST = 0xbea,
/*20161228 to latest
2등 당첨
Win 2nd prize
*/
	MSG_ZENY_LOTTO_WIN_2ND = 0xbeb,
/*20161228 to latest
3등 당첨
Win 3rd prize
*/
	MSG_ZENY_LOTTO_WIN_3RD = 0xbec,
...
Currently not in use
*/
	MSG_DONOT_USE_2 = 0xbee,
/*20161228 to latest
제니 로또 당첨자
Zeny Lottery winner
*/
	MSG_ZENY_LOTTO_PRIZE_WINNER = 0xbef,
/*20161228 to 20170111
복권 진행일
20170118 to latest
복권 구매 금액
Lottery purchase amount
*/
	MSG_ZENY_LOTTO_TOTAL_ZENY = 0xbf0,
/*20161228 to latest
참여 캐릭터
Participating character
*/
	MSG_ZENY_LOTTO_TOTAL_CHARACTER = 0xbf1,
/*20161228 to latest
1등
1st Price
*/
	MSG_WINNER_1ST = 0xbf2,
/*20161228 to latest
2등
2nd Price
*/
	MSG_WINNER_2ND = 0xbf3,
/*20161228 to latest
3등
3rd Price
*/
	MSG_WINNER_3RD = 0xbf4,
/*20161228 to latest
구매 보상 아이템
Purchase Reward Item
*/
	MSG_ZENY_LOTTO_REWARD_ITEM = 0xbf5,
/*20161228 to latest
^1a1a1a복권 ^b%d개^/b를
...
HP
*/
	MSG_BASICINFO_HP = 0xbfc,
/*20161228 to latest
SP
*/
	MSG_BASICINFO_SP = 0xbfd,
/*20161228 to latest
Lv
Lv.
*/
	MSG_BASICINFO_LEVEL = 0xbfe,
/*20161228 to latest
Lv
Lv.
*/
	MSG_BASICINFO_JOBLEVEL = 0xbff,
/*20161228 to latest
Exp
*/
	MSG_BASICINFO_EXP = 0xc00,
/*20161228 to latest
 all on
*/
	MSG_ALL_ON = 0xc01,
...
Start replay
*/
	MSG_REPLAY_BTN_TOOLTIP = 0xc02,
/*20161228 to latest
P
*/
	MSG_SIMPLECASH_P = 0xc03,
/*20161228 to latest
Total
*/
	MSG_SIMPLECASH_TOTAL = 0xc04,
/*20161228 to latest
Basicinfo
*/
	MSG_REPLAY_BASICINFO = 0xc05,
/*20161228 to latest
Equip
Equipment
*/
	MSG_REPLAY_EQUIP = 0xc06,
/*20161228 to latest
Item
Items
*/
	MSG_REPLAY_ITEM = 0xc07,
/*20161228 to latest
Skill
Skills
*/
	MSG_REPLAY_SKILL = 0xc08,
/*20161228 to latest
Guild
*/
	MSG_REPLAY_GUILD = 0xc09,
/*20161228 to latest
Party
*/
	MSG_REPLAY_PARTY = 0xc0a,
/*20161228 to latest
Chatting
Chat
*/
	MSG_REPLAY_CHATTING = 0xc0b,
/*20161228 to latest
Shortcut
Hotkeys
*/
	MSG_REPLAY_SHORTCUT = 0xc0c,
/*20161228 to latest
Status
*/
	MSG_REPLAY_STATUS = 0xc0d,
/*20161228 to latest
ALL
*/
	MSG_REPLAY_ALL = 0xc0e,
/*20161228 to latest
User Defined File Name
Custom file name
*/
	MSG_REPLAY_USER_DEFINED_FILE_NAME = 0xc0f,
/*20161228 to latest
Repeated File Check
Check file
*/
	MSG_REPLAY_REPEATED_FILE_CHECK = 0xc10,
/*20161228 to latest
on
*/
	MSG_ON = 0xc11,
...
<Basic>
*/
	MSG_BASIC_SKIN = 0xc12,
/*20161228 to latest
Select Skin
Choose skin
*/
	MSG_BASIC_SELECT_SKIN = 0xc13,
#endif
...
*/
	MSG_RESULT_FAIL_ZENYLOTTO = 0xc14,
/*20170111 to latest
/achievement
*/
	MSG_ACHIEVEMENT_COMMAND = 0xc15,
/*20170111 to latest
제니 복권
Zeny Lottery ticket
*/
	MSG_ZENY_LOTTO_RODEX_SENDER = 0xc16,
/*20170111 to latest
제니 복권 %d등 당첨 보상
Zenyy Lottery %dprize reward
*/
	MSG_ZENY_LOTTO_RODEX_WINNER_TITLE = 0xc17,
/*20170111 to latest
%d등 당첨 보상: %s
%dprize reward: %s
*/
	MSG_ZENY_LOTTO_RODEX_WINNER_CONTENTS = 0xc18,
/*20170111 to latest
제니 복권 누적 구매 보상
Zeny Lottery Cumulative purchase reward
*/
	MSG_ZENY_LOTTO_RODEX_PURCHASE_TITLE = 0xc19,
/*20170111 to latest
누적 %d회 보상: %s
Cumulative %d times reward: %s
*/
	MSG_ZENY_LOTTO_RODEX_PURCHASE_CONTENTS = 0xc1a,
/*20170111 to latest
제니 복권 구매 환불
Zeny Lottery Refund
*/
	MSG_ZENY_LOTTO_RODEX_REFUND_TITLE = 0xc1b,
...
*/
	MSG_ZENY_LOTTO_RODEX_REFUND_CONTENTS = 0xc1c,
/*20170111 to latest
미니 파티창 추가
Add Mini Party Chat
*/
	MSG_ADD_MINI_PARTYWND = 0xc1d,
/*20170111 to latest
미니 파티창 삭제
Delete Mini Party Chat
*/
	MSG_DELETE_MINI_PARTYWND = 0xc1e,
#endif
...
*/
	MSG_ZENY_LOTTO_SELL_END = 0xc1f,
/*20170118 to latest
%d월 %d일
%dMonth %dDay
*/
	MSG_DATE_MM_DD = 0xc20,
/*20170118 to latest
다음 등급까지
Till the next grade
*/
	MSG_ACHIEVEMENT_NEXT_GRADE = 0xc21,
/*20170118 to latest
전체
All
*/
...
Incomplete
*/
	MSG_INCOMPLETE = 0xc23,
/*20170118 to latest
(달성!)
(Accomplished!)
*/
	MSG_ZENY_LOTTO_ACHIEVE = 0xc24,
/*20170118 to latest
(미달성)
(Not Accomplished)
*/
	MSG_ZENY_LOTTO_ACHIEVE_FAIL = 0xc25,
#endif
...
Change equipment
*/
	MSG_SWAP_EQUIPITEM = 0xc26,
/*20170208 to latest
CHANGE
*/
	MSG_SWAP_EQUIPITEM_CHANGE = 0xc27,
/*20170208 to latest
힘 파라메터
...
Affiliated Guild
*/
	MSG_DESC_GUILD2 = 0xc32,
/*20170208 to latest
각 파라메터 레벨업에 사용되는 포인트
Points to level up each Parameter
*/
	MSG_DESC_POINT2 = 0xc33,
/*20170208 to latest
마법공격력
Magic Attack
*/
	MSG_DESC_MATK2 = 0xc34,
/*20170208 to latest
마법방어력
Magic Defense
*/
	MSG_DESC_MDEF2 = 0xc35,
/*20170208 to latest
회피율
Dodge
*/
	MSG_DESC_FLEE2 = 0xc36,
/*20170208 to latest
공격 속도
Attack Speed
*/
	MSG_DESC_ASPD2 = 0xc37,
#endif
...
*/
	MSG_SKILL_HOTKEY_F1_F9 = 0xc3a,
/*20170215 to latest
이미지 캡쳐
Capture Image
*/
	MSG_IMAGE_CAPTURE = 0xc3b,
/*20170215 to latest
확대
Zoom In
*/
...
*/
	MSG_CANNOT_MOVE_MINI_PARTYWND = 0xc49,
/*20170222 to latest
%.1f%% ( 기본 100%% + 프리미엄 %.1f%%+ %s서버 %.1f%% )
%.1f%% ( Base 100%% + Premium %.1f%%+ %sServer %.1f%% )
*/
	MSG_BASIC_EXP_MSG_FRA = 0xc4a,
#endif
...
Chinese character
*/
	MSG_CHINESE_CHARACTER = 0xc4b,
/*20170228 to latest
단축키 설정
Shortcut Settings
*/
	MSG_HOTKEY_SETTING = 0xc4c,
#endif
...
*/
	MSG_EXPIRED_DATE = 0xc4d,
/*20170308 to latest
리플레이 파일을 찾지 못하였습니다.
Cannot find the replay file.
*/
	MSG_NOT_FOUND_REPLAY_FILE = 0xc4e,
...
Head
*/
	MSG_STORE_TABNAME_8 = 0xc50,
/*20170308 to latest
갑옷
Armor
*/
	MSG_STORE_TABNAME_9 = 0xc51,
/*20170308 to latest
어깨
Shoulders
*/
	MSG_STORE_TABNAME_10 = 0xc52,
/*20170308 to latest
악세
Accessory
*/
	MSG_STORE_TABNAME_11 = 0xc53,
/*20170308 to 20170801
의상
Shoes
20170809 to latest
...
Normal Gear
*/
	MSG_GENERAL_EQUIPMENT_TOOLTIP = 0xc56,
/*20170308 to 20170308
...
Special Gear
*/
	MSG_SHADOW_EQUIPMENT_TOOLTIP = 0xc57,
/*20170308 to 20170308
...
Style
*/
	MSG_TITLE_EQUIPMENT_TOOLTIP = 0xc58,
#endif
...
*/
	MSG_HELP_QUAKE_ONOFF = 0xc59,
/*20170315 to latest
/aura2 : 오오라를 완전히 Off 시킬 수 있습니다 On Off
/aura2 : You can completely turn off the aurora On/Off
*/
	MSG_HELP_AURA_EFFECT_OFF = 0xc5a,
/*20170315 to latest
기본 설정
Default Settings
*/
	MSG_GRAPHIC_SETTING_TAB_BASIC = 0xc5b,
/*20170315 to latest
고급 설정
Advanced Settings
*/
	MSG_GRAPHIC_SETTING_TAB_ADVANCED = 0xc5c,
/*20170315 to latest
기본설정값이 적용됩니다. 
The Default Settings will be applied. 
*/
	MSG_GRAPHIC_SETTING_TOOLTIP_RESET = 0xc5d,
/*20170315 to latest
기본 설정값이 적용됩니다. 동의하십니까?
The Default Settings will be applied. Do you agree?
*/
	MSG_GRAPHIC_SETTING_WARNING_RESET = 0xc5e,
/*20170315 to latest
설정값이 적용됩니다. 동의하십니까?
The settings will be applied. Do you agree?
*/
	MSG_GRAPHIC_SETTING_APPLY = 0xc5f,
/*20170315 to latest
설정값을 적용하려면 재시작이 필요합니다. 동의하십니까?
Need to restart to apply the settings. Do you agree?
*/
	MSG_GRAPHIC_SETTING_WARNING_RESTART = 0xc60,
/*20170315 to latest
안개
Fog
*/
	MSG_GRAPHIC_SETTING_FOG_CHECK = 0xc61,
/*20170315 to latest
오오라 간략화
Simplified aurora
*/
	MSG_GRAPHIC_SETTING_SIMPLE_AURA_CHECK = 0xc62,
/*20170315 to latest
오오라켜기
Turn on aurora
*/
	MSG_GRAPHIC_SETTING_AURA_OFF_CHECK = 0xc63,
/*20170315 to latest
이펙트 표시
Show Effect
*/
	MSG_GRAPHIC_SETTING_EFFECT_CHECK = 0xc64,
/*20170315 to latest
음영 표시
Show Shadows
*/
	MSG_GRAPHIC_SETTING_LIGHTMAP_CHECK = 0xc65,
/*20170315 to latest
No Shift
*/
	MSG_GRAPHIC_SETTING_NOSHIFT_CHECK = 0xc66,
/*20170315 to latest
하드웨어 T&L 가속기능을 선택합니다
Select Hardware T&L Acceleration Function
*/
	MSG_GRAPHIC_SETTING_TOOLTIP_DEVICE = 0xc67,
/*20170315 to latest
게임의 해상도를 선택합니다
Select Game Resolution
*/
	MSG_GRAPHIC_SETTING_TOOLTIP_RESOLUTION = 0xc68,
/*20170315 to latest
전체화면 사용
Use full screen
*/
	MSG_GRAPHIC_SETTING_FULLSCREEN_CHECK = 0xc69,
/*20170315 to latest
마우스 고정
Fix mouse
*/
	MSG_GRAPHIC_SETTING_MOUSE_EXCLUSIVE_CHECK = 0xc6a,
/*20170315 to latest
이펙트 설정
Effect Settings
*/
	MSG_GRAPHIC_SETTING_EFFECT_SET = 0xc6b,
/*20170315 to latest
Control 설정
Control Settings
*/
	MSG_GRAPHIC_SETTING_CONTROL_SET = 0xc6c,
/*20170315 to latest
그래픽 장치 설정
Graphic Device Settings
*/
	MSG_GRAPHIC_SETTING_DEVICE_SET = 0xc6d,
/*20170315 to latest
그래픽 해상도 설정
Graphic Resolution Settings
*/
	MSG_GRAPHIC_SETTING_RESOLUTION_SET = 0xc6e,
/*20170315 to latest
전체 화면 유무 설정
Full Screen Settings
*/
	MSG_GRAPHIC_SETTING_FULLSCREEN_SET = 0xc6f,
/*20170315 to latest
마우스 고정 여부 설정
Fix mouse Settings
*/
	MSG_GRAPHIC_SETTING_MOUSE_SET = 0xc70,
/*20170315 to latest
수수료 : 
Commission : 
*/
	MSG_STORE_ASSISTANT_TRADE_FEE = 0xc71,
/*20170315 to latest
수수료 총액 : 
Total commission amount : 
*/
	MSG_STORE_ASSISTANT_TRADE_TOTAL_FEE = 0xc72,
/*20170315 to latest
수신인 설정
Select receiver
*/
	MSG_CHATWND_RECEIVER_LIST = 0xc73,
/*20170315 to latest
수신그룹 설정
Select receiving group
*/
	MSG_CHATWND_RECEPTIVE_GROUP_LIST = 0xc74,
/*20170315 to latest
크기 변경(F10)
Change size(F10)
*/
	MSG_CHATWND_CHANGE_SIZE = 0xc75,
/*20170315 to latest
메일함을 불러오는 중 입니다.
...
*/
	MSG_RODEX_DOWNLOADING = 0xc76,
/*20170315 to latest
NOW LOADING..
Loading...
*/
	MSG_RODEX_NOW_LOADING = 0xc77,
/*20170315 to latest
제목
Title
*/
	MSG_RODEX_TITLE = 0xc78,
/*20170315 to latest
보낸이
Sender
*/
	MSG_RODEX_SENDER = 0xc79,
#endif
#if PACKETVER >= 20170322
/*20170322 to latest
라그나로크 클라이언트와 동시에 실행이 불가능 합니다. setup을 종료합니다
*/
	MSG_CLOSE_SETUP = 0xc7a,
/*20170322 to latest
추가 기능 설정
*/
	MSG_OPEN_COMMAND_LIST_WND = 0xc7b,
/*20170322 to latest
This account does not exist.
*/
	MSG_TAREN_LOGINREFUSE_FAIL_ACCOUNT_NOTEXIST = 0xc7c,
/*20170322 to latest
Passwords do not match.
*/
	MSG_TAREN_LOGINREFUSE_FAIL_PASSWORD = 0xc7d,
/*20170322 to latest
Failed to pass IP authentication
*/
	MSG_TAREN_LOGINREFUSE_FAIL_IP = 0xc7e,
/*20170322 to latest
No identification number, supplement your registration information
*/
	MSG_TAREN_LOGINREFUSE_FAIL_PERSONALNUMBER = 0xc7f,
/*20170322 to latest
Account block
*/
	MSG_TAREN_LOGINREFUSE_FAIL_ACCOUNT_BLOCK = 0xc80,
/*20170322 to latest
System error
*/
	MSG_TAREN_LOGINREFUSE_FAIL_SYSTEM = 0xc81,
/*20170322 to latest
unknown error found.
*/
	MSG_TAREN_LOGINREFUSE_FAIL_UNKNOWN = 0xc82,
#endif
#if PACKETVER >= 20170329
/*20170329 to latest
길안내 아이콘 설정
*/
	MSG_NAVIGATION_ICONTITEL = 0xc83,
/*20170329 to latest
길 안내 정보 UI
*/
	MSG_NAVIGATION_RUITELISTTITEL = 0xc84,
/*20170329 to latest
길 안내 정보 열기
*/
	MSG_NAVIGATION_ROADLISTVIEW = 0xc85,
/*20170329 to latest
현재 위치 공유
*/
	MSG_NAVIGATION_SHARETIP = 0xc86,
/*20170329 to latest
검색결과[0]
*/
	MSG_NAVIGATION_SEARCH_01 = 0xc87,
/*20170329 to latest
검색&안내
*/
	MSG_NAVIGATION_SEARCHTORUITE = 0xc88,
/*20170329 to 20170329
위치 값은 음수 값이 들어 올 수 없습니다.
20170405 to latest
위치가 올바르지 않습니다.
*/
	MSG_NAVIGATION_SHARE_DESC = 0xc89,
/*20170329 to latest
검색결과[%d]
*/
	MSG_NAVIGATION_SEARCH_02 = 0xc8a,
/*20170329 to latest
길안내 표시를 위한 아이콘 설정
*/
	MSG_NAVIGATION_ICONTIP = 0xc8b,
/*20170329 to latest
길 찾기에 zeny 허용
*/
	MSG_NAVIGATION_SERVICETIP = 0xc8c,
/*20170329 to latest
내비게이션 도킹 해제
*/
	MSG_WORLDMAP_NAVIGATION_SET = 0xc8d,
/*20170329 to latest
활성화 하지 않은 계정입니다.
*/
	MSG_TAREN_LOGINREFUSE_FAIL_NOTACTIVATED = 0xc8e,
#endif
#if PACKETVER >= 20170405
/*20170405 to latest
클릭한 위치가 채팅창에 공유 됩니다.
*/
	MSG_NAVIGATION_V4_HELP = 0xc8f,
/*20170405 to latest
4. Service 항목을 선택하면 Zeny&비공정 이용을 고려하여 안내 한다.
*/
	MSG_NAVIGATION_V4_HELP01 = 0xc90,
/*20170405 to latest
5. [<-] 버튼 : 길안내 모드 <-> 검색 모드를 바꾸거나
*/
	MSG_NAVIGATION_V4_HELP02 = 0xc91,
/*20170405 to latest
공유하기 모드 -> 서치 모드로 돌아갈때 사용 된다.
*/
	MSG_NAVIGATION_V4_HELP03 = 0xc92,
/*20170405 to latest
경험치 %lld 얻음
*/
	MSG_GOT_EXPERIENCE_POINT_INT64 = 0xc93,
/*20170405 to latest
'%lld'의 경험치를 
*/
	MSG_NOTIFY_EXP_INT64 = 0xc94,
...
100,000,001 z 이상
 = 수수료율 : ^1567fe5%^000000
*/
	MSG_CHARGE_FEE_HELP = 0xc95,
/*20170405 to latest
실거래가 : 
*/
	MSG_METCHANT_SHOP_PRICE_INCLUDED_CHARGE_FEE = 0xc96,
/*20170405 to latest
※ 아이템 판매시, 실거래가만큼 제니를 획득합니다.
*/
	MSG_WARNING_METCHANT_SHOP_SELL = 0xc97,
/*20170405 to latest
※ 아이템 구매시, 실거래가만큼 제니가 차감됩니다.
*/
	MSG_WARNING_METCHANT_SHOP_BUY = 0xc98,
/*20170405 to latest
채팅방 개설
*/
	MSG_MAKE_CHAT_ROOM = 0xc99,
#endif
#if PACKETVER >= 20170412
/*20170412 to latest
해당 캐릭터는 파티가입이 가능하지 않은 레벨입니다.
*/
	MSG_CANNOT_JOIN_CHARACTER_HAVING_LOW_SKILL = 0xc9a,
/*20170412 to latest
'%lld'의 잡경험치를 
*/
	MSG_NOTIFY_JOBEXP_INT64 = 0xc9b,
/*20170412 to latest
잡경험치 %lld 얻음
*/
	MSG_GOT_JOB_EXPERIENCE_POINT_INT64 = 0xc9c,
#endif
#if PACKETVER >= 20170419
/*20170419 to latest
현재위치(대로)에는 노점을 개설할 수 없습니다.
*/
	MSG_MERCHANTSHOP_FAIL_POSITION = 0xc9d,
#endif
#if PACKETVER >= 20170426
/*20170426 to latest
초 후 가능합니다.
*/
	MSG_SWAP_EQUIPITEM_WAITING = 0xc9e,
#endif
#if PACKETVER >= 20170517
/*20170517 to latest
파티원
*/
	MSG_PARTYMEMBER = 0xc9f,
/*20170517 to latest
SNS 전송실패(%d)
*/
	MSG_CONNECT_SNS_FAIL_SEND = 0xca0,
/*20170517 to latest
SNS 서버 연결실패
*/
	MSG_CONNECT_SNS_FAIL_CONNECT = 0xca1,
/*20170517 to latest
SNS 로그인 후 사용 가능합니다.
*/
	MSG_CONNECT_SNS_FAIL_CUZ_NOT_CONNECTING = 0xca2,
/*20170517 to latest
접속 할 수 있는 주소가 존재하지 않습니다.
*/
	MSG_CONNECT_NOT_HAVE_URL = 0xca3,
#endif
#if PACKETVER >= 20170524
/*20170524 to latest
미니파티창이 겹쳐져 있어 사용하실 수 없습니다.
*/
	MSG_GET_OFF_MINI_PARTYWND = 0xca4,
#endif
#if PACKETVER >= 20170531
/*20170531 to latest
나의 판매노점
*/
	MSG_SALESTORE_MYSHOPWND_TITLE = 0xca5,
#endif
...
팁박스
*/
	MSG_MENUICON_TIPBOX = 0xca7,
#endif
#if PACKETVER >= 20170621
/*20170621 to latest
트윗을 성공했습니다.
*/
	MSG_CONNECT_SNS_SUCCESS_SEND = 0xca8,
#endif
...
*/
	MSG_REFINING_AGAIN_FAILED_INGREDIENT_CHANGED = 0xcaa,
/*20170628 to latest
제련석이 부족하여 다시하기가 비활성화 되었습니다.
*/
	MSG_REFINING_AGAIN_FAILED_LACK_OF_INGREDIENT = 0xcab,
/*20170628 to latest
제니가 부족하여 다시하기가 비활성화 되었습니다.
*/
	MSG_REFINING_AGAIN_FAILED_LACK_OF_MONEY = 0xcac,
/*20170628 to latest
대장장이의 축복이 부족하여 다시하기가 비활성화 되었습니다.
*/
	MSG_REFINING_AGAIN_FAILED_LACK_OF_BLACKSMITHBLESSING = 0xcad,
/*20170628 to latest
아이템이 파괴되었습니다.
*/
	MSG_REFINING_FAIL_BROKEN_ITEM = 0xcae,
/*20170628 to latest
모든 스테이터스가 감소되었습니다.
*/
	MSG_NPC_ALL_STAT_DOWN = 0xcaf,
/*20170628 to latest
모든 스테이터스 감소 효과가 해제되었습니다.
*/
	MSG_NPC_ALL_STAT_DOWN_RESET = 0xcb0,
/*20170628 to latest
OTP 비밀번호는 8자리 입니다.
*/
	MSG_OTP_MUST_8_CHAR = 0xcb1,
#endif
#if PACKETVER >= 20170705
/*20170705 to latest
통합계정
*/
	MSG_ACCOUNTCLASS_INTEGRATION = 0xcb2,
/*20170705 to latest
라그나로크
*/
	MSG_ACCOUNTCLASS_RAGNAROK = 0xcb3,
/*20170705 to latest
서비스 점검 중입니다.
*/
	MSG_FAIL_SERVICE_CHECKING_ERROR = 0xcb4,
/*20170705 to latest
검색어를 입력해주세요
*/
	MSG_ENTER_THE_SEARCH_WORD = 0xcb5,
/*20170705 to latest
MOTP
*/
	MSG_MOTP = 0xcb6,
...
Identification number.
*/
	MSG_AUTHORIZATION_CODE = 0xcb7,
/*20170705 to latest
휴대폰에 다운받은 GNJOY MOTP를 실행하여 인증번호를 입력해 주세요.
*/
	MSG_ENTER_YOUR_AUTHENTICATION_NUMBER = 0xcb8,
#endif
#if PACKETVER >= 20170712
/*20170712 to latest
파티장을 위임할 파티원이 존재하지 않습니다. 파티를 해산하시겠습니까?
*/
	MSG_PARTY_DO_YOU_WANT_BREAKING_UP = 0xcb9,
#endif
#if PACKETVER >= 20170719
/*20170719 to latest
 - 만18세이상
*/
	MSG_SERVER_PROPERTY_ADULT_NO_COUNT = 0xcba,
/*20170719 to latest
 - 유료서버
*/
	MSG_SERVER_PROPERTY_PAY_NO_COUNT = 0xcbb,
/*20170719 to latest
 - 무료서버
*/
	MSG_SERVER_PROPERTY_FREE_NO_COUNT = 0xcbc,
/*20170719 to latest
쾌적
*/
	MSG_SERVER_USERCOUNT_STATE_NICE = 0xcbd,
/*20170719 to latest
보통
Normal
*/
	MSG_SERVER_USERCOUNT_STATE_NORMAL = 0xcbe,
/*20170719 to latest
혼잡
*/
	MSG_SERVER_USERCOUNT_STATE_BUSY = 0xcbf,
/*20170719 to latest
포화
*/
	MSG_SERVER_USERCOUNT_STATE_VERY_BUSY = 0xcc0,
/*20170719 to latest
map
*/
	MSG_MENUICON_MAP = 0xcc1,
/*20170719 to latest
월드창고는 인벤토리 아이템만 입출고 할 수 있습니다.
*/
	MSG_WORLDSTORE_ONLY_INVENTORY = 0xcc2,
/*20170719 to latest
월드창고에는 펫알을 입고할 수 없습니다.
*/
	MSG_WORLDSTORE_PUT_BLOCK_PETEGG = 0xcc3,
/*20170719 to latest
월드창고에는 제작아이템을 입고할 수 없습니다.
*/
	MSG_WORLDSTORE_PUT_BLOCK_MANUFACTUREDITEM = 0xcc4,
/*20170719 to latest
%s 에서는 출고 할 수 없는 아이템입니다.
*/
	MSG_WORLDSTORE_OUT_BLOCK = 0xcc5,
#endif
#if PACKETVER >= 20170726
/*20170726 to latest
던전 파괴
*/
	MSG_MEMORIAL_DUN_DESTROY = 0xcc6,
/*20170726 to latest
[%s] 님이 제련을 성공하여, [+%d %s] 아이템을 획득하였습니다.
*/
	MSG_BROADCASTING_REFINING_SUCCESS_LEVEL_9 = 0xcc7,
/*20170726 to latest
[%s] 님이 [+%d %s] 아이템의 제련에 실패하였습니다.
*/
	MSG_BROADCASTING_REFINING_FAIL_LEVEL_9 = 0xcc8,
/*20170726 to latest
파티장을 위임한 이후에 탈퇴할 수 있습니다.
*/
	MSG_PARTY_NOT_LEAVE_PARTY_UNTIL_YIELD_PARTYMASTER = 0xcc9,
#endif
#if PACKETVER >= 20170809
/*20170809 to latest
오름
*/
	MSG_ASCENDING_ORDER = 0xcca,
/*20170809 to latest
내림
*/
	MSG_DESENDING_ORDER = 0xccb,
/*20170809 to latest
기본
*/
	MSG_DEFAULT = 0xccc,
...
File abusing detected. Please restart the client with clean files.
*/
	MSG_CHEATDEFENDER_FILE_CHECK_FAIL = 0xccd,
#endif
#if PACKETVER >= 20170823
/*20170823 to latest
%s 은(는) 이맵에서 이동이 제한된 아이템입니다.
*/
	MSG_ITEMMOVERESTRICT_WHITELIST = 0xcce,
#endif
...
먹이먹기
*/
	MSG_HOMUN_SELF_FEEDING = 0xccf,
/*20170906 to latest
로덱스 작성창이 열려있는 동안 호문클루스가 먹이를 먹지 못합니다.
*/
	MSG_FAILED_HOMUN_SELF_FEEDING_CLOSE_RODEX = 0xcd0,
/*20170906 to latest
호문클루스가 먹이를 먹었습니다. '%s' 잔여량 %d개
*/
	MSG_HOMUN_SELF_FEEDING_REST = 0xcd1,
/*20170906 to latest
호문클루스 스스로 먹이 먹기 활성화 On
*/
	MSG_HOMUN_SELF_FEEDING_ON = 0xcd2,
/*20170906 to latest
호문클루스 스스로 먹이 먹기 활성화 Off
*/
	MSG_HOMUN_SELF_FEEDING_OFF = 0xcd3,
/*20170906 to latest
호문클루스는 주인이 획득하는 경험치의
10%만큼을 자신의 경험치로 분배 받습니다.
*/
	MSG_HOMUN_SELF_FEEDING_EXP_INFORMATION = 0xcd4,
/*20170906 to latest
확률 : %d%%
*/
	MSG_REFINING_RATE = 0xcd5,
/*20170906 to latest
해당 대상은 호문의 공격대상이 아닙니다. 'Alt + 우클릭'을 통해 호문클루스의 공격대상을 지정해주세요.
*/
	MSG_HOMUN_TARGET_IS_NOT_HOMUN_TARGET = 0xcd6,
/*20170906 to latest
호문의 공격대상이 존재하지 않습니다. 'Alt + 우클릭'을 통해 호문클루스의 공격대상을 지정해주세요.
*/
	MSG_HOMUN_TARGET_NOT_EXIST_HOMUN_TARGAT = 0xcd7,
#endif
#if PACKETVER >= 20170913
/*20170913 to latest
판매 리스트
*/
	MSG_CASHSHOP_SALE_LIST = 0xcd8,
/*20170913 to latest
구입 리스트
*/
	MSG_CASHSHOP_BUY_LIST = 0xcd9,
/*20170913 to latest
신규
New
*/
	MSG_CASHSHOP_TAB_NEW = 0xcda,
/*20170913 to latest
인기
Headgears
*/
	MSG_CASHSHOP_TAB_HOT = 0xcdb,
/*20170913 to latest
한정
Limited
*/
	MSG_CASHSHOP_TAB_LIMITED = 0xcdc,
/*20170913 to latest
임대장비
Rental Items
*/
	MSG_CASHSHOP_TAB_LEASE = 0xcdd,
/*20170913 to latest
영구장비
Equipments
*/
	MSG_CASHSHOP_TAB_PERMANENT = 0xcde,
/*20170913 to latest
버프
Scrolls
*/
	MSG_CASHSHOP_TAB_BUFF = 0xcdf,
/*20170913 to latest
회복
Consumables
*/
	MSG_CASHSHOP_TAB_RECOVERY = 0xce0,
/*20170913 to latest
기타
Other
*/
	MSG_CASHSHOP_TAB_ETC = 0xce1,
/*20170913 to latest
특가
Special
*/
	MSG_CASHSHOP_TAB_BARGAIN = 0xce2,
/*20170913 to latest
충전하기
*/
	MSG_CASHSHOP_CASH_CHARGE = 0xce3,
/*20170913 to latest
구입하기
*/
	MSG_CASHSHOP_ITEM_BUY = 0xce4,
/*20170913 to 20171206
https://payment.gnjoy.com/bill/login.grv
20171213 to latest
http://member.gnjoy.com/user/pay/chargelist.asp
*/
	MSG_CASHSHOP_CASH_CHARGE_ADDRESS = 0xce5,
/*20170913 to latest
아이템 검색
*/
	MSG_ITEM_SEARCH = 0xce6,
/*20170913 to latest
무료캐시
*/
	MSG_CASHSHOP_FREE_POINT = 0xce7,
/*20170913 to latest
무료캐시 사용
*/
	MSG_CASHSHOP_FREE_POINT_TO_USE = 0xce8,
/*20170913 to latest
소지캐시
*/
	MSG_CASHSHOP_CASH_POINT = 0xce9,
/*20170913 to latest
수량갱신
*/
	MSG_CASHSHOP_REFRESH = 0xcea,
/*20170913 to latest
성제(여)
*/
	MSG_STAR_EMPEROR_F = 0xceb,
/*20170913 to latest
소울리퍼(여)
*/
	MSG_SOUL_REAPER_F = 0xcec,
/*20170913 to latest
성제(남)
*/
	MSG_STAR_EMPEROR_M = 0xced,
/*20170913 to latest
소울리퍼(남)
*/
	MSG_SOUL_REAPER_M = 0xcee,
#endif
#if PACKETVER >= 20170920
/*20170920 to latest
무게가 %d 퍼센트 이상일때는 HP SP가 자연적으로 회복이 되지 않습니다.
*/
	MSG_NO_RECOVER_OVERWEIGHT2 = 0xcef,
/*20170920 to latest
한 번에 구입 가능한 아이템의 가짓수는 8개입니다.
*/
	MSG_CASHSHOP_CANNOT_BUY_OVER = 0xcf0,
...
http://gift.zhaouc.com/
*/
	MSG_OUTSIDE_CASHSHOP_LINK = 0xcf1,
#endif
#if PACKETVER >= 20170927
/*20170927 to latest
UNKNOWN ERROR:%d
*/
	MSG_USA_LOGINERRORMSG_UNKNOWN = 0xcf2,
/*20170927 to latest
NOT USER
*/
	MSG_USA_LOGINERRORMSG_NOT_USER = 0xcf3,
/*20170927 to latest
THIS ACCOUNT ID IS BLOCKED
*/
	MSG_USA_LOGINERRORMSG_ID_BLOCK = 0xcf4,
/*20170927 to latest
COUNTRY REJECT (OR NOT AVALIABLE USER )
*/
	MSG_USA_LOGINERRORMSG_ID_INACTIVAT = 0xcf5,
/*20170927 to latest
NOT MATCH PASSWORD
*/
	MSG_USA_LOGINERRORMSG_PASSWORD = 0xcf6,
/*20170927 to latest
NOT EMAIL CERT
*/
	MSG_USA_LOGINERRORMSG_EMAIL_CERT = 0xcf7,
/*20170927 to latest
PAYPAL BLOCK
*/
	MSG_USA_LOGINERRORMSG_PAYPAL_BLOCK1 = 0xcf8,
/*20170927 to latest
COUNTRY REJECT
*/
	MSG_USA_LOGINERRORMSG_COUNTRY_REJECT = 0xcf9,
/*20170927 to latest
PAYPAL BLOCK
*/
	MSG_USA_LOGINERRORMSG_PAYPAL_BLOCK2 = 0xcfa,
/*20170927 to latest
WEB BLOCK
*/
	MSG_USA_LOGINERRORMSG_WEB_BLOCK = 0xcfb,
/*20170927 to latest
AGE LIMIT USER
*/
	MSG_USA_LOGINERRORMSG_AGE = 0xcfc,
/*20170927 to latest
PASSWORD HAS NOT BEEN CHANGED FOR MORE THAN 90DAYS
*/
	MSG_USA_LOGINERRORMSG_PASSWORD_CHANGE = 0xcfd,
/*20170927 to latest
INPUT DATA ERROR
*/
	MSG_USA_LOGINERRORMSG_INPUTDATA = 0xcfe,
/*20170927 to latest
ERROR DATABASE
*/
	MSG_USA_LOGINERRORMSG_DATABASE = 0xcff,
/*20170927 to latest
ERROR SYSTEM
*/
	MSG_USA_LOGINERRORMSG_SYSTEM = 0xd00,
/*20170927 to 20171025
%s 지불
20171101 to latest
%s 소모
*/
	MSG_PAY_BY_ITEM = 0xd01,
/*20170927 to latest
비용지불
*/
	MSG_PRIVATE_AIRPLANE_PAYMENT = 0xd02,
/*20170927 to latest
출발 가능한 맵이 아닙니다.
*/
	MSG_PRIVATE_AIRPLANE_FAILED_ISNOT_STARTABLE_MAP = 0xd03,
/*20170927 to latest
이동 불가능한 맵입니다
*/
	MSG_PRIVATE_AIRPLANE_FAILED_ISNOT_ENDABLE_MAP = 0xd04,
/*20170927 to latest
아이템이 부족합니다.
*/
	MSG_PRIVATE_AIRPLANE_FAILED_NOT_ENOUGH_ITEM = 0xd05,
/*20170927 to latest
줄 바꿈 없이 한 줄로 입력해주세요.
*/
	MSG_ENTER_ONE_LINE_WITHOUT_LINE_BREAKS = 0xd06,
#endif
#if PACKETVER >= 20171011
/*20171011 to latest
불량 단어가 포함된 이름은 등록할 수 없습니다.
*/
	MSG_CANNOT_REGISTER_NAME_THAT_CONTAINS_BADWORDS = 0xd07,
#endif
#if PACKETVER >= 20171018
/*20171018 to latest
회원 가입을 위해 공식 홈페이지로 이동됩니다.
*/
	MSG_CREATE_ACCOUNT = 0xd08,
#endif
#if PACKETVER >= 20171025
/*20171025 to latest
TokenAgency 서버 연결 실패
*/
	MSG_TOKENAGENCY_SERVER_CONNECTION_FAILED = 0xd09,
/*20171025 to latest
과금정보
*/
	MSG_SELECTCHARWND_BILLING_INFO = 0xd0a,
/*20171025 to latest
삭제예약
*/
	MSG_SELECTCHARWND_RESERVE_TO_DEL_CHAR = 0xd0b,
/*20171025 to latest
예약취소
*/
	MSG_SELECTCHARWND_CANCEL_TO_RESERVE_CHAR = 0xd0c,
/*20171025 to latest
게임시작
*/
	MSG_SELECTCHARWND_START_GAME = 0xd0d,
/*20171025 to latest
삭제
Delete
*/
	MSG_SELECTCHARWND_DELETE = 0xd0e,
/*20171025 to latest
Character List
*/
	MSG_SELECTCHARWND_CHARACTER_LIST = 0xd0f,
/*20171025 to latest
공지
Notice
*/
	MSG_SELECTCHARWND_NOTICE = 0xd10,
/*20171025 to latest
생성
*/
	MSG_MAKECHARWND_CREATE = 0xd11,
/*20171025 to latest
Hair Style
*/
	MSG_MAKECHARWND_HAIR_STYLE = 0xd12,
/*20171025 to latest
Hair Color
*/
	MSG_MAKECHARWND_HAIR_COLOR = 0xd13,
/*20171025 to latest
중복확인
*/
	MSG_MAKECHARWND_DOUBLECHECK_NAME = 0xd14,
/*20171025 to latest
%d시 %d분 %d초
*/
	MSG_DATE_HH_MM_SS = 0xd15,
/*20171025 to latest
MOTP 입력 시간이 초과되었습니다. 처음부터 다시 로그인해주십시오.
*/
	MSG_INPUT_TIME_EXCEEDED_SIGN_IN_AGAIN = 0xd16,
/*20171025 to latest
뒤로가기
*/
	MSG_MAKECHARWND_CLOSE = 0xd17,
#endif
#if PACKETVER >= 20171101
/*20171101 to latest
아이템을 사용할 수 없습니다.
*/
	MSG_PRIVATE_AIRPLANE_FAILED_USE_ITEM = 0xd18,
/*20171101 to latest
동일한 맵으로 이동할 수 없습니다.
*/
	MSG_PRIVATE_AIRPLANE_FAILED_SAME_MAP = 0xd19,
/*20171101 to latest
사망시 이동이 불가능합니다.
*/
	MSG_PRIVATE_AIRPLANE_FAILED_DEAD_STATE = 0xd1a,
/*20171101 to latest
캐릭터 생성
*/
	MSG_MAKECHARWND_TITLE = 0xd1b,
#endif
#if PACKETVER >= 20171108
/*20171108 to latest
모험가 중개소 등록
*/
	MSG_REGISTER_ADVENTURER_AGENCY = 0xd1c,
/*20171108 to 20191120
모집 중단
20191127 to latest
모험가 중개소 등록하기
*/
	MSG_REGISTER_ADVENTURER_AGENCY2 = 0xd1d,
/*20171108 to 20191120
모험가 중개소 설정
20191127 to latest
모집 중단
*/
	MSG_STOP_RECRUITING = 0xd1e,
/*20171108 to 20191120
전 지역
20191127 to latest
메모
...
Quest
*/
	MSG_ADVEN_QUEST = 0xd20,
/*20171108 to 20191120
검사계열
20191127 to latest
필드
*/
	MSG_ADVEN_FIELD = 0xd21,
/*20171108 to 20191120
법사계열
20191127 to latest
던전
...
Search
*/
	MSG_ADVEN_SEARCH = 0xd26,
/*20171108 to 20191120
태권계열
20191127 to latest
초기화
*/
	MSG_ADVEN_RESET = 0xd27,
/*20171108 to 20191120
닌자계열
20191127 to latest
파티가입신청
*/
	MSG_ADVEN_JOIN_PARTY = 0xd28,
/*20171108 to 20191120
건슬링거계열
20191127 to latest
목적
*/
	MSG_ADVEN_PURPOSE = 0xd29,
/*20171108 to 20191120
도람족계열
20191127 to latest
※욕설, 현거래등 운영 규칙에 위배되는 목적으로 사용 시 처벌 받을 수 있습니다.
*/
	MSG_ADVEN_WARNING_TEXT = 0xd2a,
/*20171108 to 20191120
지역명
20191127 to latest
등록하기
Register
*/
	MSG_ADVEN_REGISTER = 0xd2b,
/*20171108 to 20191120
지역명 검색
20191127 to latest
사용할 수 없는 단어가 포함되어 있습니다.
*/
	MSG_INCLUDE_BAD_WORD = 0xd2c,
/*20171108 to 20191120
가입 요청하기
20191127 to latest
파티가입
...
1:1대화
*/
	MSG_CHAT_WITH_PARTYMASTER = 0xd2e,
/*20171108 to 20191120
파티 모집 중단
20191127 to latest
모집 중지
*/
	MSG_STOP_RECRUITING_PARTY = 0xd2f,
/*20171108 to 20191120
지역명을 입력해주세요.
20191127 to latest
수정하기
*/
	MSG_ADVEN_REWRITE = 0xd30,
/*20171108 to 20191120
지역
20191127 to latest
전체
...
*/
	MSG_OTPWND_DESCRIPTION_1 = 0xd39,
/*20171108 to latest
실행하여 인증번호를 입력해 주세요.
*/
	MSG_OTPWND_DESCRIPTION_2 = 0xd3a,
/*20171108 to latest
NPC가 있는 맵의 랜덤 좌표로 이동 됩니다.
*/
	MSG_PRIVATE_AIRPLANE_WARNNING_SELECT_NPC = 0xd3b,
/*20171108 to latest
태권
Taekwon
*/
	MSG_JOBNAME_TAEKWON = 0xd3c,
#endif
...
20171122 to latest
 에게 전체채팅 및 귓말 거부상태
*/
	MSG_TO_BLOCK_WHISPER = 0xd3d,
/*20171115 to 20171115
 님을 차단 상태로 설정하는데 실패하였습니다.
20171122 to latest
 에게 전체채팅 및 귓말 거부 요청 실패
*/
	MSG_TO_BLOCK_WHISPER_FAILED1 = 0xd3e,
/*20171115 to 20171115
 님을 차단 상태로 설정하는데 실패하였습니다.(인원 초과)
20171122 to latest
 에게 전체채팅 및 귓말 거부 요청실패 (인원초과)
*/
	MSG_TO_BLOCK_WHISPER_FAILED2 = 0xd3f,
/*20171115 to 20171115
 님이 차단 해제 되었습니다.
20171122 to latest
 에게 전체채팅 및 귓말 가능상태
*/
	MSG_TO_UNBLOCK_WHISPER = 0xd40,
/*20171115 to 20171115
 님을 차단 해제하는데 실패하였습니다.
20171122 to latest
 에게 전체채팅 및 귓말 가능 요청실패
*/
	MSG_TO_UNBLOCK_WHISPER_FAILED1 = 0xd41,
/*20171115 to 20171115
 님을 차단 해제하는데 실패하였습니다.(인원 초과)
20171122 to latest
 에게 전체채팅 및 귓말 가능 요청실패 (인원초과)
*/
	MSG_TO_UNBLOCK_WHISPER_FAILED2 = 0xd42,
/*20171115 to latest
차단 리스트가 없습니다
Ignore-list is empty
*/
	MSG_NO_BLOCK_LIST = 0xd43,
/*20171115 to latest
-차단 리스트-
Characters in ignore-list:
*/
	MSG_BLOCK_LIST = 0xd44,
/*20171115 to latest
진행중
Act
*/
	MSG_RENEW_QUEST_TAB_PROCESS = 0xd45,
/*20171115 to latest
추천
Rec
*/
	MSG_RENEW_QUEST_TAB_BEST = 0xd46,
/*20171115 to latest
보류중
Pen
*/
	MSG_RENEW_QUEST_TAB_HOLD = 0xd47,
/*20171115 to latest
QUEST
*/
	MSG_RENEW_QUEST_TITLE = 0xd48,
/*20171115 to latest
내용
For
*/
	MSG_RENEW_QUEST_DETAIL_DESCRIPTION = 0xd49,
/*20171115 to latest
몬스터
*/
	MSG_RENEW_QUEST_DETAIL_MONSTER = 0xd4a,
/*20171115 to latest
보상
*/
	MSG_RENEW_QUEST_DETAIL_REWARD = 0xd4b,
/*20171115 to latest
EXP
*/
	MSG_RENEW_QUEST_DETAIL_EXP = 0xd4c,
/*20171115 to latest
JEXP
*/
	MSG_RENEW_QUEST_DETAIL_JEXP = 0xd4d,
/*20171115 to latest
아이템
Item
*/
	MSG_RENEW_QUEST_DETAIL_ITEM = 0xd4e,
/*20171115 to latest
진행/보류
*/
	MSG_RENEW_QUEST_CHECK_TOOTIP1_ITEM = 0xd4f,
/*20171115 to latest
하단으로 이동
*/
	MSG_RENEW_QUEST_CHECK_TOOTIP2_ITEM = 0xd50,
/*20171115 to latest
간편 퀘스트창에 표시
*/
	MSG_RENEW_QUEST_CHECK_TOOTIP3_ITEM = 0xd51,
/*20171115 to latest
입력시간
*/
	MSG_OTP_INPUT_TIME = 0xd52,
#endif
...
Leader
*/
	MSG_PARTY_MASTER = 0xd57,
/*20171122 to 20191120
슈퍼노비스계열
20191127 to latest
파티에 가입할 수 있는 레벨이 아닙니다.
*/
	MSG_CANNOT_APPLY_LEVEL = 0xd58,
/*20171122 to latest
모험가 중개소 등록에 실패했습니다.
*/
	MSG_ADVENTURER_AGENCY_REGIST_FAILED = 0xd59,
/*20171122 to latest
모험가 중개소에 등록되었습니다.
*/
	MSG_ADVENTURER_AGENCY_REGIST_SUCCESSED = 0xd5a,
...
검색내용입력
*/
	MSG_INPUT_SEARCH_TEXT = 0xd5b,
/*20171122 to 20191127
지역명을 두 글자 이상 입력해주세요.
20191204 to latest
탱커
*/
	MSG_ADVEN_TANKER = 0xd5c,
/*20171122 to latest
%.1f%% (+ %s서버 %.1f%%)
*/
	MSG_BASIC_EXP_ZERO = 0xd5d,
/*20171122 to latest
/ex (캐릭터이름) or /차단 (캐릭터이름) : 해당 캐릭터에 대해 전체채팅 및 귓말 차단
*/
	MSG_EXPLAIN_CHAT_BLOCK = 0xd5e,
/*20171122 to latest
/in (캐릭터이름) or /해제 (캐릭터이름) : 해당 캐릭터에 대해 전체채팅 및 귓말 허용
*/
	MSG_EXPLAIN_CHAT_UNBLOCK = 0xd5f,
/*20171122 to latest
/ex or /차단 : 전체채팅 및 귓말 차단 캐릭터 리스트
*/
	MSG_EXPLAIN_CHAT_BLOCKLIST = 0xd60,
/*20171122 to latest
/exall or /차단전부 : 모두에게 전체채팅 및 귓말 차단
*/
	MSG_EXPLAIN_CHAT_BLOCK_TO_ALL = 0xd61,
/*20171122 to latest
/inall or /해제전부 : 모두에게 전체채팅 및 귓말 허용
*/
	MSG_EXPLAIN_CHAT_UNBLOCK_TO_ALL = 0xd62,
/*20171122 to latest
모두에게 전체채팅 및 귓말 거부상태
*/
	MSG_REFUSE_CHAT_TO_EVERYONE = 0xd63,
/*20171122 to latest
모두에게 전체채팅 및 귓말 거부요청 실패
*/
	MSG_FAILED_TO_ALL_CHAT_PERMIT = 0xd64,
/*20171122 to latest
모두에게 전체채팅 및 귓말 가능상태
*/
	MSG_PERMIT_CHAT_TO_EVERYONE = 0xd65,
/*20171122 to latest
모두에게 전체채팅 및 귓말 가능요청 실패
*/
	MSG_FAILED_TO_ASK_ALL_CHAT = 0xd66,
/*20171122 to latest
오프닝
*/
	MSG_OPENING = 0xd67,
...
로그인 화면으로 돌아가시겠습니까?
*/
	MSG_DO_YOU_WANT_TO_BACK_LOGINWND = 0xd68,
/*20171206 to latest
힘과 공격력이 강해졌습니다.
*/
	MSG_ENST_SHOUT2 = 0xd69,
/*20171206 to latest
힘, 지능, 손재주 및 명중률이 증가하였습니다.
*/
	MSG_ENST_BLESSING2 = 0xd6a,
/*20171206 to latest
방어력 및 HP가 증가되었습니다.
*/
	MSG_ENST_ANGELUS2 = 0xd6b,
/*20171206 to latest
젤스타
*/
	MSG_CASHSHOP_TAB_JELLSTAR = 0xd6c,
/*20171206 to latest
계정버프
*/
	MSG_CASHSHOP_TAB_EFST_AID = 0xd6d,
/*20171206 to latest
정액서비스
*/
	MSG_CASHSHOP_TAB_PREMIUM_SERVICE = 0xd6e,
#endif
#if PACKETVER >= 20171213
/*20171213 to latest
현재 접속이 지연되고 있습니다. 순차적으로 접속이 가능하니 잠시 후 재접속 부탁드립니다.
*/
	MSG_REFUSE_RETRY_CONNECT_AC = 0xd6f,
/*20171213 to latest
현재 접속이 지연되고 있으니 잠시 후 재접속 부탁드립니다.
*/
	MSG_REFUSE_RETRY_CONNECT_TC = 0xd70,
/*20171213 to latest
불량 단어가 포함된 이름은 검색할 수 없습니다.
*/
	MSG_CANNOT_FIND_NAME_THAT_CONTAINS_BADWORDS = 0xd71,
/*20171213 to 20191127
파티 마스터가 요청을 받을 수 없는 맵에 있습니다.
20191204 to latest
파티 마스터가 요청을 받을 수 없는 상태입니다.
*/
	MSG_THE_PARTY_MASTER_CANNOT_BE_REQUESTED = 0xd72,
/*20171213 to latest
파티를 찾을 수 없습니다.
*/
	MSG_NO_PARTY_FOUND = 0xd73,
...
딜러
*/
	MSG_ADVEN_DEARER = 0xd74,
#endif
#if PACKETVER >= 20171220
/*20171220 to latest
http://ro.gnjoy.com
*/
	MSG_WEB_ADDRESS_FOR_RESTART = 0xd75,
/*20171220 to latest
▲
*/
	MSG_QUESTWND_HIGHER = 0xd76,
/*20171220 to latest
▼
*/
	MSG_QUESTWND_LOWER = 0xd77,
#endif
#if PACKETVER >= 20171227
/*20171227 to latest
이미 친구입니다
*/
	MSG_FRIEND_ALREADY_FRIEND = 0xd78,
/*20171227 to latest
상대방을 찾을 수 없습니다
*/
	MSG_FRIEND_CAN_NOT_FIND = 0xd79,
/*20171227 to latest
이미 다른 캐릭터가 친구 신청 중입니다.
*/
	MSG_FRIEND_ALREADY_JOINING = 0xd7a,
/*20171227 to latest
혼구슬 표시 ON
*/
	MSG_SPRITEMABLE_ON = 0xd7b,
/*20171227 to latest
혼구슬 표시 OFF
*/
	MSG_SPRITEMABLE_OFF = 0xd7c,
#endif
...
*/
	MSG_BAN_BLOCK_CHARCTER_SERVER_SECOND_PASSWORD = 0xd7d,
/*20180117 to latest
보안패스워드를 3회이상 틀리셨습니다. 계정 보안을 위해 24시간동안 게임내 접속이 제한됩니다.
 접속제한의 해제는 홈페이지 -> 개인정보변경 -> 2차 비밀번호 에서 본인인증 후 진행해주시기 바랍니다.
*/
	MSG_SECOND_PASSWORD_INFO_5 = 0xd7e,
/*20180117 to latest
운영진
*/
	MSG_CHECK_ATTENDANCE_RODEX_SENDER = 0xd7f,
/*20180117 to latest
%d일차 출석 보상이 지급되었습니다.
*/
	MSG_CHECK_ATTENDANCE_RODEX_CONTENTS = 0xd80,
/*20180117 to 20180117
계정설정정보 받아오는데 실패 했습니다.( 재시도를 위해서는 재시작 해야 합니다. )
20180124 to latest
계정 설정 데이터를 불러오는 중에 오류가 발생했습니다. ( 재시도를 위해서는 재시작 해야 합니다. )
*/
	MSG_ACCOUNTLINKEDUSERDATA_LOAD_FAIL = 0xd81,
/*20180117 to latest
해당 스킬은 파티 상태에서 사용 가능합니다.
*/
	MSG_USESKILL_FAIL_NOT_PARTY_MEMBER = 0xd82,
#endif
#if PACKETVER >= 20180124
/*20180124 to latest
파티 모집을 중단하였습니다.
*/
	MSG_ADVENTURER_AGENCY_RECRUIT_STOP = 0xd83,
/*20180124 to latest
길드 상납 경험치는 최대 %d%%까지 가능합니다.
*/
	MSG_CANNOT_OFFER_GUILD_EXP_MAX_RATE = 0xd84,
/*20180124 to latest
길드 레벨이 최대여서 더 이상 경험치를 상납할 수 없습니다.
*/
	MSG_CANNOT_OFFER_GUILD_EXP_MAX_LEVEL = 0xd85,
#endif
...
*/
	MSG_FORCED_WEB_LOGIN = 0xd86,
/*20180207 to latest
물리 공격력과 마법 공격력이 향상되었습니다.
*/
	MSG_INC_ATTACKDAMAGE_ABILITYPOWER = 0xd87,
/*20180207 to latest
물리 공격력과 마법 공격력이 감소되었습니다.
*/
	MSG_DEC_ATTACKDAMAGE_ABILITYPOWER = 0xd88,
/*20180207 to latest
%s 출석체크 보상
%s Attendance Check Reward
*/
	MSG_CHECK_ATTENDANCE_REWARD = 0xd89,
...
*/
	MSG_CHECK_ATTENDANCE_DATE_INFO = 0xd8a,
/*20180207 to latest
%d일차
%d Day
*/
	MSG_CHECK_ATTENDANCE_DATE_COUNT = 0xd8b,
/*20180207 to latest
%d일차 출석체크
클릭해주세요~!
...
Please click~!
*/
	MSG_CHECK_ATTENDANCE_CHECK_BEFORE = 0xd8c,
/*20180207 to latest
%d일차 출석 성공!
%d Day attendance success!
*/
	MSG_CHECK_ATTENDANCE_CHECK_AFTER = 0xd8d,
/*20180207 to latest
D-day
*/
	MSG_CHECK_ATTENDANCE_DDAY = 0xd8e,
/*20180207 to latest
일
Day
*/
...
*/
	MSG_CHECK_ATTENDANCE_FAIL_RESTART = 0xd90,
/*20180207 to latest
출석체크
Attendance Check
*/
	MSG_CHECK_ATTENDANCE = 0xd91,
/*20180207 to latest
현재 출석체크 이벤트 기간이 아닙니다
This is not the current attendance check event
*/
	MSG_CHECK_ATTENDANCE_NOT_EVENT = 0xd92,
/*20180207 to 20180328
길드 상납 경험치가 max에 도달하여, 더 이상 길드 경험치를 누적할 수 없습니다
20180404 to latest
길드 상납 경험치가 max에 도달하여, 더 이상 길드 경험치를 누적할 수 없습니다.
*/
	MSG_CAN_NOT_OFFER_EXP_TO_GUILD_MAX_LV = 0xd93,
/*20180207 to latest
개인 상납 경험치가 max에 도달하여, 더 이상 길드 경험치를 누적할 수 없습니다.

*/
	MSG_CAN_NOT_OFFER_EXP_TO_GUILD_MAX_EXP = 0xd94,
#endif
#if PACKETVER >= 20180213
/*20180213 to latest
메시지
*/
	MSG_MESSAGEWND_TITLE = 0xd95,
/*20180213 to latest
트위터에 메세지 전송을 실패 했습니다.
*/
	MSG_SEND_TO_TWITTER_FAILED = 0xd96,
/*20180213 to latest
영문 4자, 한글 2자 이상으로 입력해야 합니다.
Enter 4 english words and 2 chinese words
*/
	MSG_KEYWORD_FILTER = 0xd97,
#endif
#if PACKETVER >= 20180307
/*20180307 to latest
몬스터의 테이밍이 불가능한 지역입니다.
*/
	MSG_DISABLE_TAMINGMONSTER_MAP = 0xd98,
#endif
#if PACKETVER >= 20180321
/*20180321 to latest
순위를 가져오고 있습니다...
*/
	MSG_RANK_LOADING = 0xd99,
/*20180321 to latest
해당 스킬은 파티장일때만 사용 가능합니다.
*/
	MSG_USESKILL_FAIL_NOT_PARTY_MASTER = 0xd9a,
#endif
#if PACKETVER >= 20180404
/*20180404 to latest
파트너의 SP가 부족하거나, 스킬 사용 불가 상태입니다.
*/
	MSG_USESKILL_FAIL_ENSEMBLE_PARTYNER = 0xd9b,
/*20180404 to latest
아르바이트 노점 강제 종료 알림메일
*/
	MSG_STORE_ASSISTANT_TRADE_FORCED_REMOVAL_TITLE = 0xd9c,
/*20180404 to latest
안녕하세요. 운영팀입니다.
...
감사합니다
*/
	MSG_STORE_ASSISTANT_TRADE_FORCED_REMOVAL_CONTENT = 0xd9d,
/*20180404 to latest
50% 이상의 값을 입력할 수 없습니다.
The guild tax rate can't be set to more than 50%.
*/
	MSG_CAN_NOT_OFFER_EXP_LIMIT_RATE = 0xd9e,
/*20180404 to 20191204
파티 가입 요청을 보냈습니다.
20191211 to latest
파티가 모험가 중개소에 등록되어, 파티장을 변경 할 수 없습니다.
*/
	MSG_CANNOT_CHANGE_PARTYMASTER = 0xd9f,
/*20180404 to latest
모험가 중개소에 파티를 등록할 수 없습니다
*/
	MSG_CANNOT_REGISTER_PARTY = 0xda0,
/*20180404 to latest
수락
*/
	MSG_ACCEPT = 0xda1,
...
힐러
*/
	MSG_ADVEN_HEALER = 0xda3,
/*20180404 to latest
해당 캐릭터를 찾을 수 없습니다.
*/
	MSG_CANNOT_FIND_REQUEST_USER = 0xda4,
/*20180404 to latest
노점 강제 철거
*/
	MSG_STORE_ASSISTANT_TRADE_FORCED_REMOVAL = 0xda5,
/*20180404 to latest
해당 파티의 파티장을 찾을 수 없습니다.
*/
	MSG_CANNOT_FIND_PARTYMASTER = 0xda6,
/*20180404 to latest
잡레벨이 낮아 파티에 가입 할 수 없습니다.
*/
	MSG_CANNOT_JOIN_PARTY_BECAUSE_LOW_LEVEL = 0xda7,
/*20180404 to latest
현재 요청자가 파티가입이 불가능한 지역에 있습니다.
*/
	MSG_INVALID_MAPPROPERTY_REQUEST_USER = 0xda8,
/*20180404 to latest
파티 인원수가 초과되었습니다.
*/
	MSG_EXCEEDED_NUMBER_OF_PARTYMEMBERS = 0xda9,
/*20180404 to latest
%s 파티의 파티장이 파티 가입을 승인했습니다.
*/
	MSG_JOIN_ACCEPT = 0xdaa,
/*20180404 to latest
%s 파티의 파티장이 파티 가입을 거부했습니다.
*/
	MSG_JOIN_REFUSE = 0xdab,
/*20180404 to latest
%s 님이 이미 파티에 가입 중입니다.
*/
	MSG_ALREADY_JOINED_REQUEST_USER = 0xdac,
/*20180404 to latest
%s 님의 파티 가입을 수락했습니다.
*/
	MSG_JOIN_ACCEPT_REQUEST_USER = 0xdad,
/*20180404 to latest
%s 님의 파티 가입을 거부했습니다.
*/
	MSG_JOIN_REFUSE_REQUEST_USER = 0xdae,
/*20180404 to latest
파티 요청을 받을 수 없는 상태여서 %s님의 신청이 거절되었습니다.
*/
	MSG_REQUEST_REJECTED_BECAUSE_INVALID_MAPPROPERTY = 0xdaf,
/*20180404 to latest
모험가 중개소 리스트
*/
	MSG_ADVENTURER_AGENCY_LIST = 0xdb0,
/*20180404 to latest
파티 가입 요청
*/
	MSG_REQUEST_JOIN_PARTY = 0xdb1,
/*20180404 to 20191120
파티장이 아닌 경우, 모험가 중개소에 파티를 등록할 수 없습니다.
20191127 to latest
파티장이 아닌 경우 모험가 중개소에 파티를 등록할 수 없습니다.
*/
	MSG_NOT_PARTYMASTER_CANNOT_REGISTER_ADVENTURER_AGENCY = 0xdb2,
/*20180404 to 20180404
파티 모집 중단에 실패했습니다.
20180418 to latest
파티 모집을 중단할 수 없습니다.
*/
	MSG_ADVENTURER_AGENCY_RECRUIT_STOP_FAILED = 0xdb3,
#endif
...
Support
*/
	MSG_ADVEN_ASSIST = 0xdb4,
/*20180418 to 20180418
시야 확장
20180425 to latest
Zoom Out
*/
	MSG_EXPAND_SIGHT_OPTIONWND = 0xdb5,
/*20180418 to 20180418
%s : 시야확장을 켜거나 끌수 있습니다 On Off
20180425 to latest
%s : Zoom Out을 켜거나 끌수 있습니다 On Off
*/
	MSG_EXPAND_SIGHT_HELP = 0xdb6,
/*20180418 to 20180418
시야를 확장합니다(On)
20180425 to latest
Zoom Out 기능을 켭니다 (On)
*/
	MSG_EXPAND_SIGHT_ON = 0xdb7,
/*20180418 to 20180418
시야확장을 해제합니다(Off)
20180425 to latest
Zoom Out 기능을 해제합니다 (Off)
*/
	MSG_EXPAND_SIGHT_OFF = 0xdb8,
/*20180418 to 20180418
/expandsight
20180425 to latest
/zoom
*/
	MSG_EXPAND_SIGHT = 0xdb9,
/*20180418 to latest
모험가 중개소
*/
	MSG_ADVENTURER_AGENCY = 0xdba,
/*20180418 to latest
파티장인 경우, 가입 요청을 할 수 없습니다.
*/
	MSG_CANNOT_ASK_TO_JOIN_PARTY = 0xdbb,
/*20180418 to 20191211
모험가 중개소에 등록 중입니다. 잠시만 기다려 주세요.
20191218 to latest
파티 가입 최대 레벨은 최소 레벨 설정보다 높아야 합니다.
*/
	MSG_CHECK_LEVEL_BEFORE_REGISTER_AGENCY = 0xdbc,
/*20180418 to latest
더 이상 직업을 선택할 수 없습니다.
*/
	MSG_CANNOT_MORE_SELECT_JOB = 0xdbd,
/*20180418 to 20191120
게임 중 해당 유저의 가입 요청을 받지 않습니다.
20191127 to latest
게임 중 해당 유저의 가입 요청을 받지 않습니다.(클라이언트 종료 전까지 유효)
*/
	MSG_D0_NOT_RECEIVE_THE_USER_REQUEST_TODAY = 0xdbe,
#endif
#if PACKETVER >= 20180502
/*20180502 to latest
잠시 후 다시 열어주시기 바랍니다.
*/
	MSG_PLEASE_REOPEN_LISTWND_AFTER_A_WHILE = 0xdbf,
/*20180502 to latest
공성시작 전 %d분 동안은 해당 기능을 이용하실 수 없습니다.
*/
	MSG_BEFORE_SIEGE_BLOCKMOVE_TIME = 0xdc0,
#endif
#if PACKETVER >= 20180516
/*20180516 to latest
/viewclear
*/
	MSG_EXPAND_OBJALPHA = 0xdc1,
/*20180516 to latest
건물 반 투명화 ON
*/
	MSG_HALFALPHAOBJ_ON = 0xdc2,
/*20180516 to latest
건물 반 투명화 OFF
*/
	MSG_HALFALPHAOBJ_OFF = 0xdc3,
/*20180516 to latest
건물 투명화
*/
	MSG_GRAPHIC_SETTING_OBJALPHA = 0xdc4,
/*20180516 to latest
알로 되돌리기가 실패했습니다. 로덱스 작성창을 닫아주세요.
*/
	MSG_FAILED_PET_TO_EGG_CLOSE_RODEX = 0xdc5,
/*20180516 to latest
Emblem Frame
*/
	MSG_EMBLEM_FRAME = 0xdc6,
/*20180516 to latest
Emblem 테두리를 그려줍니다
*/
	MSG_EMBLEM_FRAME_DRAW_ON = 0xdc7,
/*20180516 to latest
Emblem 테두리를 그려주지 않습니다
*/
	MSG_EMBLEM_FRAME_DRAW_OFF = 0xdc8,
#endif
#if PACKETVER >= 20180605
/*20180605 to latest
장착된 무기가 없습니다.
*/
	MSG_USESKILL_FAIL_NEED_EQUIPPED_WEAPONE = 0xdc9,
/*20180605 to latest
에너지 구체가 부족합니다.
*/
	MSG_USESKILL_FAIL_EMPTY_SOUL_ENERGY = 0xdca,
/*20180605 to latest
배울 수 없는 스킬(%s)이 포함되어있습니다.
*/
	MSG_ADDSKILL_FAIL_INCLUDE_SKILL_YOU_CANNOT_LEARN = 0xdcb,
/*20180605 to latest
/frame
*/
	MSG_DRAW_EMBLEM_FRAME_ONOFF = 0xdcc,
#endif
#if PACKETVER >= 20180620
/*20180620 to latest
웨폰 블로킹 발동후 제한시간 내에 사용가능한 스킬입니다.
*/
	MSG_USESKILL_FAIL_GC_WEAPONBLOCK_ON = 0xdcd,
#endif
#if PACKETVER >= 20180704
/*20180704 to latest
아이디혹은 패스워드가 잘못되었읍니다.
*/
	MSG_REFUSE_LOGIN_AUTH = 0xdce,
#endif
...
*/
	MSG_RUSSIA_PERSONALINFO_EXP = 0xdcf,
/*20180718 to latest
DROP  : %.1f%% ( basic 100.0%% %s %.1f%%)
DROP: %.1f%% (basic: 100.0%%, %s: %.1f%%)
*/
	MSG_RUSSIA_PERSONALINFO_DROP = 0xdd0,
/*20180718 to latest
DEATH : %.1f%% ( basic 100.0%% %s %.1f%%)
DEATH: %.1f%% (basic: 100.0%%, %s: %.1f%%)
*/
	MSG_RUSSIA_PERSONALINFO_DEATH = 0xdd1,
#endif
...
*/
	MSG_RUSSIA_CHAR_NAME_RULES = 0xdd2,
/*20180829 to latest
you must have an AccessTicket to login
*/
	MSG_REFUSE_LOGIN_ACCESSTICKET = 0xdd3,
/*20180829 to latest
창고를 불러오는 중입니다.
Loading....
*/
	MSG_ITEMSTORE_DOWNLOADING = 0xdd4,
/*20180829 to latest
NOW LOADING..
Loading...
*/
	MSG_ITEMSTORE_NOW_LOADING = 0xdd5,
#endif
...
Delete
*/
	MSG_RODEX_BUTTON_DELETE = 0xdd6,
/*20181002 to latest
답장
Reply
*/
	MSG_RODEX_BUTTON_ANSWER = 0xdd7,
/*20181002 to latest
전송
Send
*/
	MSG_RODEX_BUTTON_SEND = 0xdd8,
/*20181002 to latest
이름확인
Name Check
*/
	MSG_RODEX_BUTTON_CONFIRM_ID = 0xdd9,
/*20181002 to latest
공지
Notice
*/
	MSG_RODEX_TAB_ADMIN = 0xdda,
/*20181002 to latest
일반
General
*/
	MSG_RODEX_TAB_DEFAULT = 0xddb,
/*20181002 to latest
반송
Clear
*/
	MSG_RODEX_TAB_RETURN = 0xddc,
/*20181002 to latest
검색
Search
*/
	MSG_RODEX_TAB_SEARCH = 0xddd,
#endif
#if PACKETVER >= 20181031
/*20181031 to latest
펫 먹이주기에 실패했습니다. 먹이를 줄 수 없는 상태입니다.
*/
	MSG_FAILED_PET_AUTO_FEEDING_BY_ITEMACTION = 0xdde,
/*20181031 to latest
호문 먹이주기에 실패했습니다. 먹이를 줄 수 없는 상태입니다.
*/
	MSG_FAILED_HOMUN_AUTO_FEEDING_BY_ITEMACTION = 0xddf,
/*20181031 to latest
화폐
*/
	MSG_MSG_INVENTORY_TABNAME_4 = 0xde0,
/*20181031 to latest
%s %d개
*/
	MSG_BARTERITEM_NAME_COUNT = 0xde1,
/*20181031 to latest
교환에 실패하였습니다.
*/
	MSG_EXCHANGED_FAILED = 0xde2,
/*20181031 to latest
교환이 잘 이루어졌습니다.
*/
	MSG_EXCHANGED_SUCCEEDED = 0xde3,
/*20181031 to latest
교환에 필요한 재화가 부족합니다.
*/
	MSG_NO_ITEM_FOR_EXCHANGE = 0xde4,
/*20181031 to latest
해당 아이템은 이미 판매되어 재고가 부족합니다.
*/
	MSG_ITEM_OUT_OF_STOCK = 0xde5,
/*20181031 to latest
사망
*/
	MSG_DEAD = 0xde6,
...
아이템 소지 확장
*/
	MSG_INVENTORY_EXTEND_OF_BODYITEM = 0xde8,
...
Taming monster
*/
	MSG_TRANSLATE_CAPTURE_MONSTER = 0xdf5,
/*20190109 to latest
message
*/
	MSG_TRANSLATE_MESSAGE = 0xdf6,
/*20190109 to latest
TITLE
Header
*/
	MSG_TRANSLATE_TITLE = 0xdf7,
/*20190109 to latest
데미지 표기 확장
*/
	MSG_EXTEND_DAMAGE_RANGE = 0xdf8,
#endif
#if PACKETVER >= 20190213
/*20190213 to latest
맵 이름 표기
*/
	MSG_SHOW_NAME_OF_ENTERED_MAP = 0xdf9,
/*20190213 to latest
시스템 메세지 : 현재 노점보기 기능이 %s 상태입니다. (/노점보기)
*/
	MSG_SYSTEM_MSG_MERCHANTSHOP = 0xdfa,
/*20190213 to latest
수직 동기
*/
	MSG_VSYNC = 0xdfb,
...
자료
*/
	MSG_WEBSITE_LINK_BTN_TOOLTIP = 0xdfc,
/*20190213 to 20190228
http://rodata.zhaouc.com/renwu.html#container
20190306 to latest
http://rodata.zhaouc.com/renwu.html
*/
	MSG_WEBSITE_LINK_ADDRESS = 0xdfd,
/*20190213 to latest
작위
*/
	MSG_OUTSIDE_CASHSHOP_BTN_TOOLTIP = 0xdfe,
/*20190213 to latest
프레임 제한
*/
	MSG_LIMIT_FRAME = 0xdff,
#endif
#if PACKETVER >= 20190227
/*20190227 to latest
%d개를 초과할 경우 더 이상 설치 할 수 없습니다.
*/
	MSG_USESKILL_FAIL_OVER_INSTALLATION = 0xe00,
/*20190227 to latest
목적지
*/
	MSG_NAVIGATION_DESTINATION = 0xe01,
#endif
...
Please try again in a moment.
*/
	MSG_EMBLEM_UPLOAD_FAILED_BUSY = 0xe02,
/*20190306 to latest
등록할 수 없는 파일입니다.
*/
	MSG_EMBLEM_REGIST_FAILED_INCORRECT_SIZE = 0xe03,
#endif
#if PACKETVER >= 20190320
/*20190320 to latest
선택 삭제
*/
	MSG_RODEX_BUTTON_DELETE_SELECTED = 0xe04,
/*20190320 to latest
모두 삭제
*/
	MSG_RODEX_BUTTON_DELETE_ALL = 0xe05,
/*20190320 to latest
[%s]편지함의 모든 메일을 삭제하시겠습니까?
*/
	MSG_RODEX_MESSAGE_DELETE_ALL = 0xe06,
/*20190320 to latest
선택 받기
*/
	MSG_RODEX_BUTTON_RECEIVE_SELECTED = 0xe07,
/*20190320 to latest
모두 받기
*/
	MSG_RODEX_BUTTON_RECEIVE_ALL = 0xe08,
/*20190320 to latest
선택한 메일의 첨부 물품을 받으시겠습니까?
*/
	MSG_RODEX_MESSAGE_RECEIVE_SELECTED = 0xe09,
/*20190320 to latest
[%s]편지함의 모든 첨부 물품을 받으시겠습니까?
*/
	MSG_RODEX_MESSAGE_RECEIVE_ALL = 0xe0a,
#endif
#if PACKETVER >= 20190403
/*20190403 to latest
스킬바2
*/
	MSG_HOTKEYWND_SKILLBAR2 = 0xe0b,
/*20190403 to latest
스킬바 교체
*/
	MSG_CHANGE_SKILLBER = 0xe0c,
/*20190403 to latest
←
*/
	MSG_HOTKEYGUIDEWND_LEFT = 0xe0d,
/*20190403 to latest
↑
*/
	MSG_HOTKEYGUIDEWND_UP = 0xe0e,
/*20190403 to latest
→
*/
	MSG_HOTKEYGUIDEWND_RIGHT = 0xe0f,
/*20190403 to latest
↓
*/
	MSG_HOTKEYGUIDEWND_DOWN = 0xe10,
/*20190403 to latest
▤
*/
	MSG_HOTKEYGUIDEWND_APPS = 0xe11,
/*20190403 to latest
←
*/
	MSG_HOTKEYGUIDEWND_BACK = 0xe12,
/*20190403 to latest
로딩중에는 창을 닫을 수 없습니다.
*/
	MSG_WARNINGMSG_LOADING = 0xe13,
#endif
#if PACKETVER >= 20190417
/*20190417 to latest
리딩 스펠북으로 저장된 마법이 없습니다.
*/
	MSG_USESKILL_FAIL_SPELLBOOK_NONE = 0xe14,
/*20190417 to latest
이동 시 사용한 아이템은 재교환이 불가능합니다.
*/
	MSG_USE_WORLDMAP_WITH_PERIOD_MSG1 = 0xe15,
/*20190417 to latest
자유이동권을 구매 하였습니다
*/
	MSG_USE_WORLDMAP_WITH_PERIOD_MSG2 = 0xe16,
/*20190417 to latest
자유이동권 사용 중, 관련 아이템을 소모하지 않습니다.
*/
	MSG_USE_WORLDMAP_WITH_PERIOD_MSG3 = 0xe17,
/*20190417 to latest
적용
*/
	MSG_BTN_MESSAGE_APPLY = 0xe18,
/*20190417 to latest
중지
*/
	MSG_BTN_MESSAGE_STOP = 0xe19,
#endif
#if PACKETVER >= 20190508
/*20190508 to latest
자유이동권
*/
	MSG_USE_WORLDMAP_WITH_PERIOD_MSG4 = 0xe1a,
/*20190508 to latest
%d시간 이용, %s %d개
*/
	MSG_USE_WORLDMAP_WITH_PERIOD_MSG5 = 0xe1b,
/*20190508 to latest
자유이용권 사용중
*/
	MSG_USE_WORLDMAP_WITH_PERIOD_MSG6 = 0xe1c,
/*20190508 to latest
특성 스테이터스
*/
	MSG_ADVANCED_STATUS = 0xe1d,
/*20190508 to 20200715
파워 파라메터
^cc0000물리 공격력, 특성 공격력^ffffff 증가
20200729 to latest
파워 파라메터
^cc0000물리 공격력, 특성 물리 공격력^ffffff 증가
*/
	MSG_DESC_POW = 0xe1e,
/*20190508 to latest
스테미나 파라메터
...
20200729 to latest
스펠 파라메터
^cc0000마법 공격력, 특성 마법 공격력^ffffff 증가
*/
	MSG_DESC_SPL = 0xe21,
/*20190508 to latest
컨센트레이션 파라메터
...
특성 물리 공격력
*/
	MSG_DESC_ADV_STATUS_POWER_ATK = 0xe24,
/*20190508 to latest
특성 마법 공격력
*/
	MSG_DESC_ADV_STATUS_SPELL_MATK = 0xe25,
/*20190508 to latest
물리 저항력
*/
	MSG_DESC_ADV_STATUS_STAMINA_RESIST = 0xe26,
/*20190508 to latest
마법 저항력
*/
	MSG_DESC_ADV_STATUS_WISDOM_MRESIST = 0xe27,
/*20190508 to latest
특성 힐 회복량
*/
	MSG_DESC_ADV_STATUS_CREATIVE_HEALPULS = 0xe28,
/*20190508 to latest
크리티컬 데미지 비율
*/
	MSG_DESC_ADV_STATUS_CREATIVE_CRIDAMAGE_RATE = 0xe29,
/*20190508 to latest
특성 파라메터 레벨업에 사용되는 포인트
*/
	MSG_DESC_ADV_POINT = 0xe2a,
/*20190508 to latest
J.Lv
*/
	MSG_BASICINFO_JOBLEVEL2 = 0xe2b,
/*20190508 to latest
AP
*/
	MSG_BASICINFO_AP = 0xe2c,
#endif
#if PACKETVER >= 20190522
/*20190522 to latest
영지로 이동
*/
	MSG_GUILD_AGIT_MOVE_AGIT = 0xe2d,
/*20190522 to latest
상업도/방어도 확인
*/
	MSG_GUILD_AGIT_INVESTMENT_INFO = 0xe2e,
...
(공성전 시간에는 %d제니가 소모됩니다.)
*/
	MSG_GUILD_AGIT_ARE_YOU_MOVE_AGIT = 0xe2f,
/*20190522 to latest
...
*/
	MSG_BAN_IP_BLOCK_FOR_ZERO = 0xe33,
#endif
#if PACKETVER >= 20190717
/*20190717 to latest
탑승/장착 해제
*/
	MSG_TOOLTIP_OF_OPTIONOFF_BTN = 0xe34,
/*20190717 to latest
가져오기
*/
	MSG_MCSTORE_BACKUP = 0xe35,
/*20190717 to latest
직전 노점에 등록된 아이템 정보를 가져옵니다.
*/
	MSG_MCSTORE_BACKUP_TOOLTIP = 0xe36,
/*20190717 to latest
서버 이슈로 인해 로그인이 제한되고 있습니다.
*/
	MSG_BAN_LOGIN_IS_RESTRICTED = 0xe37,
/*20190717 to latest
메시지
*/
	MSG_GUILD_AGIT_AGIT_MESSAGE = 0xe38,
/*20190717 to latest
+18 이상만 플레이가 가능합니다.
*/
	MSG_WARNING_UNDER_AGE_MSG1 = 0xe39,
/*20190717 to latest
3시간 이상의 게임 플레이를 권장하지 않습니다.
*/
	MSG_WARNING_UNDER_AGE_MSG2 = 0xe3a,
/*20190717 to latest
AP가 부족합니다.
*/
	MSG_USESKILL_FAIL_AP_INSUFFICIENT = 0xe3b,
#endif
#if PACKETVER >= 20190731
/*20190731 to latest
제련도가 높아서 조합할 수 없습니다.
*/
	MSG_LAPINE_FAIL_REFINING_LEVEL_OVERFLOW_NEEDED = 0xe3c,
/*20190731 to latest
제련도가 조합에 필요한 요구치보다 높습니다.
*/
	MSG_LAPINE_WARNING_REFINING_LEVEL_HIGHER_THAN_NEEDED = 0xe3d,
/*20190731 to 20191107
'카드가 끼워져있거나 인챈트 되어 있습니다.
20191113 to latest
카드가 끼워져있거나 인챈트 되어 있습니다.
*/
	MSG_LAPINE_WARNING_HAS_CARD_OR_ENCHANTED = 0xe3e,
/*20190731 to latest
∞
?
*/
	MSG_ITEM_COUNT_INFINITY = 0xe3f,
/*20190731 to latest
Z
*/
	MSG_ITEMSHOP_CURRENCY = 0xe40,
/*20190731 to latest
Total : %s Zeny
*/
	MSG_PURCHASEWND_TOTAL = 0xe41,
#endif
...
*/
	MSG_ACCOUNT_LIMITED_TOOL_TITLE = 0xe42,
/*20190821 to latest
아이템 DB명
Item DB Name
*/
	MSG_ACCOUNT_LIMITED_DB_NAME = 0xe43,
/*20190821 to latest
아이템 DB번호
Item DB Number
*/
	MSG_ACCOUNT_LIMITED_TOOL_DB_NUMBER = 0xe44,
/*20190821 to latest
판매 갯수
Number of Sale
*/
	MSG_ACCOUNT_LIMITED_TOOL_SELL_COUNT = 0xe45,
/*20190821 to latest
판매 시작시간
Sale Start Time
*/
	MSG_ACCOUNT_LIMITED_TOOL_SELL_STARTTIME = 0xe46,
/*20190821 to latest
판매 종료시간
Sale end time
*/
	MSG_ACCOUNT_LIMITED_TOOL_SELL_ENDTIME = 0xe47,
/*20190821 to latest
계정 한정
Account only
*/
	MSG_ACCOUNT_LIMITED_SALE_ITEM = 0xe48,
/*20190821 to latest
판매기간 : %d월 %d일 %d시 %d분
Sale period:% d month% d day% d hours% d
*/
	MSG_ACCOUNT_LIMITED_SALE_ITEM_START_DATE = 0xe49,
...
계정당 구매가능
*/
	MSG_ACCOUNT_LIMITED_SALE_ITEM_NUM = 0xe4a,
/*20190821 to latest
%d개 한정
limited to% d
*/
	MSG_ACCOUNT_LIMITED_SALE_ITEM_LIMIT_NUM = 0xe4b,
/*20190821 to latest
...
*/
	MSG_ACCOUNT_LIMITED_TOOL_RESULT_FORMAT = 0xe4c,
/*20190821 to latest
Sold Out
*/
	MSG_ACCOUNT_LIMITED_SALE_ITEM_SOLD_OUT = 0xe4d,
/*20190821 to latest
[%s]은(는) 현재 소환할 수 없는 지역에 있습니다.
% s] is currently in a region that cannot be summoned.
*/
	MSG_MAP_PROPERTY_DISABLE_CALLED = 0xe4e,
/*20190821 to latest
~ %d월 %d일 %d시 %d분
% d min% d days% d days
*/
	MSG_ACCOUNT_LIMITED_SALE_ITEM_NEXT_DATE = 0xe4f,
/*20190821 to latest
상품을 더이상 추가할 수 없습니다
Can't add any more items
*/
	MSG_ACCOUNT_LIMITED_SALE_ITEM_DONT_MOVE_CART = 0xe50,
#endif
...
*/
	MSG_CANNOT_EXCHANGE_ITEMS = 0xe51,
#endif
...
*/
	MSG_QUIT_EXIT_AFTER_GUILD_CLOSE = 0xe52,
/*20190904 to latest
아이템 태그가 포함되어 있어 사용할 수 없습니다.
Item tag is included and cannot be used.
*/
	MSG_HAVE_ITEMTAG = 0xe53,
/*20190904 to latest
Monster
*/
	MSG_MONSTER_MONSTERINFO = 0xe54,
/*20190904 to latest
Unknown
*/
	MSG_UNKNOWN_MONSTERINFO = 0xe55,
/*20190904 to latest
Undead
*/
	MSG_UNDEAD_MONSTERINFO = 0xe56,
/*20190904 to latest
Animal
*/
	MSG_ANIMAL_MONSTERINFO = 0xe57,
/*20190904 to latest
Plant
*/
	MSG_PLANT_MONSTERINFO = 0xe58,
/*20190904 to latest
Insect
*/
	MSG_INSECT_MONSTERINFO = 0xe59,
/*20190904 to latest
Marine
*/
	MSG_MARINE_MONSTERINFO = 0xe5a,
/*20190904 to latest
Devil
*/
	MSG_DEVIL_MONSTERINFO = 0xe5b,
/*20190904 to latest
Human
*/
	MSG_HUMAN_MONSTERINFO = 0xe5c,
/*20190904 to latest
Angel
*/
	MSG_ANGEL_MONSTERINFO = 0xe5d,
/*20190904 to latest
Dragon
*/
	MSG_DRAGON_MONSTERINFO = 0xe5e,
#endif
#if PACKETVER >= 20190918
/*20190918 to latest
Balance: %s %c
*/
	MSG_NC_CASH_INNOVA = 0xe5f,
/*20190918 to latest
...
*/
	MSG_BUY_RECONFIRM_CASHSTRINGFMT = 0xe60,
/*20190918 to latest
...
*/
	MSG_BUY_RECONFIRM2_CASHSTRINGFMT = 0xe61,
/*20190918 to 20190918
[%s]의 호출이 거부되었습니다.
20190925 to latest
호출이 거부되었습니다.
*/
	MSG_CALL_REJECTED = 0xe62,
/*20190918 to latest
구매 한도액은 소지액을 초과할 수 없습니다.
*/
	MSG_BUYINGSTORE_MAKEWND_LIMITZENY_NOT_OVER_MYMONEY = 0xe63,
/*20190918 to latest
노점을 여는데 실패하였습니다. 구매노점 개설을 닫아주시기 바랍니다.
*/
	MSG_BUYINGSTORE_MAKEWND_FAIL_CLOSE_UI = 0xe64,
#endif
#if PACKETVER >= 20191002
/*20191002 to latest
판매 노점 아이템 리스트가 저장되었습니다.
*/
	MSG_SAVE_SELL_STORE_ITEMLIST = 0xe65,
/*20191002 to latest
구매 노점 아이템 리스트가 저장되었습니다.
*/
	MSG_SAVE_BUY_STORE_ITEMLIST = 0xe66,
/*20191002 to latest
VTC 인증에 실패하였습니다.
*/
	MSG_REFUSE_VTC_AUTH_FAILED = 0xe67,
#endif
#if PACKETVER >= 20191016
/*20191016 to latest
물물교환 중에는 장비를 착용할 수 없습니다.
*/
	MSG_EQUIP_FAIL_DURING_BARTER = 0xe68,
/*20191016 to latest
교환하려는 품목
*/
	MSG_BARTER_ITEMLIST = 0xe69,
/*20191016 to latest
 1차, 2차, 3차 직업 스킬 %d개를 더 올려 주십시오.
*/
	MSG_UPGRADESKILLERROR_MORE_THIRDJOBSKILL = 0xe6a,
#endif
#if PACKETVER >= 20191030
/*20191030 to latest
같은 아이템은 %d개까지 소유할 수 있습니다.
*/
	MSG_LIMIT_HAVE_ITEM_CNT = 0xe6b,
/*20191030 to latest
같은 아이템은 한 번에 %d개까지 교환할 수 있습니다.
*/
	MSG_EXCHANGE_ITEM_CNT = 0xe6c,
/*20191030 to latest
해당 로덱스는 "%s"서버에서 열 수 있습니다.
*/
	MSG_GLOBALRODEX_NOT_ABLE_TO_OPEN_MAIL_IN_CUR_SERVER = 0xe6d,
/*20191030 to latest
[공지]편지함의 모든 메일을 삭제하시겠습니까 ? 
(해당 "%s"서버의 메일만 삭제됩니다.)
*/
	MSG_GLOBALRODEX_MESSAGE_DELETE_ALL_ON_ADMIN = 0xe6e,
/*20191030 to latest
[공지]편지함의 모든 첨부 물품을 받으시겠습니까? 
(해당 "%s"서버의 메일의 물품만 받으실 수 있습니다.)
*/
	MSG_GLOBALRODEX_MESSAGE_RECEIVE_ALL = 0xe6f,
/*20191030 to latest
해당 메일은 "%s"서버에서만 삭제 가능합니다.
*/
	MSG_GLOBALRODEX_REFUSE_DELETING = 0xe70,
/*20191030 to latest
해당 메일은 "%s"서버에서만 물품 받기가 가능합니다.
*/
	MSG_GLOBALRODEX_REFUSE_RECEIVING = 0xe71,
/*20191030 to latest
해당 메일은 "%s"서버에서만 내용읽기가 가능합니다.
*/
	MSG_GLOBALRODEX_REFUSE_READING = 0xe72,
/*20191030 to latest
합계 : %d z
*/
	MSG_TOTAL_NEED_MONEY = 0xe73,
/*20191030 to latest
메세지
*/
	MSG_NORMAL_MESSAGEBOX_CAPTION = 0xe74,
#endif
#if PACKETVER >= 20191106
/*20191106 to latest
구매상점 개설 중에는 개인상점의 물건을 구입할 수 없습니다.
*/
	MSG_RESTRICT_OPENING_BUYINGSTORE_FAIL_OPEN_BUYINGSTORE = 0xe75,
#endif
#if PACKETVER >= 20191113
/*20191113 to latest
등급강화가 성공적으로 되었습니다.
*/
	MSG_ITEM_GRADE_ENCHANT_SUCCEESS = 0xe76,
/*20191113 to latest
등급강화가 실패하였습니다.
*/
	MSG_ITEM_GRADE_ENCHANT_FAIL = 0xe77,
/*20191113 to latest
등급 수치가 하향 조정 되었습니다.
*/
	MSG_ITEM_GRADE_ENCHANT_FAIL_DOWNGRADE = 0xe78,
/*20191113 to latest
장비가 파괴되었습니다.
*/
	MSG_ITEM_GRADE_ENCHANT_FAIL_BREAK = 0xe79,
/*20191113 to latest
장비가 보호되었습니다.
*/
	MSG_ITEM_GRADE_ENCHANT_FAIL_PROTECT = 0xe7a,
/*20191113 to latest
재료가 선택되지 않았습니다.
*/
	MSG_GRADE_ENCHANT_SOURCE_NOT_SELECT = 0xe7b,
/*20191113 to latest
재료가 부족합니다.
*/
	MSG_GRADE_ENCHANT_SOURCE_ENOUGH = 0xe7c,
/*20191113 to latest
소지 금액이 부족합니다.
*/
	MSG_GRADE_ENCHANT_MONEY_ENOUGH = 0xe7d,
/*20191113 to latest
아이템 공간이 부족합니다.
*/
	MSG_GRADE_ENCHANT_INVENTORY_ENOUGH = 0xe7e,
/*20191113 to latest
장비가 보호되고 있습니다.
*/
	MSG_GRADE_ENCHANT_ITEM_PROTECT = 0xe7f,
/*20191113 to latest
장비가 파괴될 수 있습니다.
*/
	MSG_GRADE_ENCHANT_ITEM_NOT_PROTECT = 0xe80,
/*20191113 to latest
등급강화 실패 시 등급이 내려갑니다.
*/
	MSG_GRADE_ENCHANT_ITEM_DOWNGRADE = 0xe81,
/*20191113 to latest
등급강화 중에는 로덱스를 사용할 수 없습니다. 로덱스를 강제 종료하였습니다.
*/
	MSG_CLOSE_RODEX_FOR_GRADE_ENCHANT = 0xe82,
/*20191113 to latest
등급강화 중에는 로덱스를 사용할 수 없습니다.
*/
	MSG_CANNOT_OPEN_RODEX_DURING_GRADE_ENCHANT = 0xe83,
/*20191113 to latest
등급강화 중에는 은행을 사용할 수 없습니다. 은행을 강제 종료하였습니다.
*/
	MSG_CLOSE_BANKING_FOR_GRADE_ENCHANT = 0xe84,
/*20191113 to latest
등급강화 중에는 은행을 사용할 수 없습니다.
*/
	MSG_CANNOT_OPEN_BANKING_DURING_GRADE_ENCHANT = 0xe85,
/*20191113 to latest
[%s] 님이 등급강화를 성공하여, [%s등급 %s] 아이템을 획득하였습니다.
*/
	MSG_BROADCASTING_GRADE_ENCHANT_SUCCESS = 0xe86,
/*20191113 to latest
[%s] 님이 [%s등급 %s] 아이템의 등급강화에 실패하였습니다.
*/
	MSG_BROADCASTING_GRADE_ENCHANT_FAIL = 0xe87,
/*20191113 to latest
등급 강화가 불가능한 장비입니다.
*/
	MSG_CANNOT_GRADE_ENCHANT_ITEM = 0xe88,
/*20191113 to latest
체인지 메테리얼
*/
	MSG_CHANGE_MATERIAL = 0xe89,
/*20191113 to latest
가나다 정렬
*/
	MSG_CHANGE_MATERIAL_SORT = 0xe8a,
/*20191113 to 20191224
기본 결과물은 %s %d개 이나, 낮은 확률로 최대 %d개까지 생성될 수 있습니다.
20200108 to latest
※[%s] %d~%d개 제작
*/
	MSG_CHANGE_MATERIAL_MESSAGE = 0xe8b,
/*20191113 to 20220615
성공 %d%%
20220629 to latest
%d%%
*/
	MSG_CHANGE_MATERIAL_SUCCESS_RATE = 0xe8c,
/*20191113 to latest
아이템 태그는 소지한 아이템만 태그할 수 있습니다.
*/
	MSG_MSG_IS_ILLEGAL_TAG_MSG = 0xe8d,
#endif
#if PACKETVER >= 20191127
/*20191127 to latest
공격력 및 특성 공격력이 증가되었습니다.
*/
	MSG_IQ_POWERFUL_FAITH_ON = 0xe8e,
/*20191127 to latest
강인한 신념 효과가 해제되었습니다.
*/
	MSG_IQ_POWERFUL_FAITH_OFF = 0xe8f,
/*20191127 to latest
HP 및 물리 저항력이 증가되었습니다.
*/
	MSG_IQ_FIRM_FAITH_ON = 0xe90,
/*20191127 to latest
굳건한 신념 효과가 해제되었습니다.
*/
	MSG_IQ_FIRM_FAITH_OFF = 0xe91,
/*20191127 to latest
공격 속도 및 유도 공격 확률이 증가되었습니다.
*/
	MSG_IQ_SINCERE_FAITH_ON = 0xe92,
/*20191127 to latest
신실한 신념 효과가 해제되었습니다.
*/
	MSG_IQ_SINCERE_FAITH_OFF = 0xe93,
/*20191127 to latest
POW, CRT 및 CON 이 증가되었습니다.
*/
	MSG_CD_BENEDICTUM_ON = 0xe94,
/*20191127 to latest
베네딕툼 효과가 해제되었습니다.
*/
	MSG_CD_BENEDICTUM_OFF = 0xe95,
/*20191127 to latest
SPL, WIS 및 CRT 가 증가되었습니다.
*/
	MSG_CD_RELIGIO_ON = 0xe96,
/*20191127 to latest
렐리지오 효과가 해제되었습니다.
*/
	MSG_CD_RELIGIO_OFF = 0xe97,
/*20191127 to latest
특성 공격력 및 특성 마법 공격력이 증가되었습니다.
*/
	MSG_CD_COMPETENTIA_ON = 0xe98,
/*20191127 to latest
콤페텐티아 효과가 해제되었습니다.
*/
	MSG_CD_COMPETENTIA_OFF = 0xe99,
/*20191127 to latest
크리티컬 데미지 비율이 증가되었습니다.
*/
	MSG_CD_PRESENS_ACIES_ON = 0xe9a,
/*20191127 to latest
프레센스 아치에스 효과가 해제되었습니다.
*/
	MSG_CD_PRESENS_ACIES_OFF = 0xe9b,
/*20191127 to latest
물리 저항력 무시 효과가 부여되었습니다.
*/
	MSG_CD_ARGUTUS_TELUM_ON = 0xe9c,
/*20191127 to latest
아르구투스 텔룸 효과가 해제되었습니다.
*/
	MSG_CD_ARGUTUS_TELUM_OFF = 0xe9d,
/*20191127 to latest
마법 저항력 무시 효과가 부여되었습니다.
*/
	MSG_CD_ARGUTUS_VITA_ON = 0xe9e,
/*20191127 to latest
아르구투스 비타 효과가 해제되었습니다.
*/
	MSG_CD_ARGUTUS_VITA_OFF = 0xe9f,
/*20191127 to latest
Num: %d/%d Weight: %d/%d
*/
	MSG_ITEMNUM_AND_WEIGHT = 0xea0,
#endif
#if PACKETVER >= 20191204
/*20191204 to latest
서번트 웨폰 효과가 해제되었습니다.
*/
	MSG_DK_SERVANTWEAPON_OFF = 0xea1,
/*20191204 to latest
챠징 피어스 효과가 해제되었습니다.
*/
	MSG_DK_CHARGINGPIERCE_OFF = 0xea2,
/*20191204 to latest
비고르 효과가 해제되었습니다.
*/
	MSG_DK_VIGOR_OFF = 0xea3,
/*20191204 to latest
공격력이 증가하고, 방어력이 감소되었습니다.
*/
	MSG_IG_ATTACK_STANCE_ON = 0xea4,
/*20191204 to latest
어택 스탠스 효과가 해제되었습니다.
*/
	MSG_IG_ATTACK_STANCE_OFF = 0xea5,
/*20191204 to latest
방어력이 증가하고, 공격력이 감소되었습니다.
*/
	MSG_IG_GUARD_STANCE_ON = 0xea6,
/*20191204 to latest
가드 스탠스 효과가 해제되었습니다.
*/
	MSG_IG_GUARD_STANCE_OFF = 0xea7,
/*20191204 to latest
배리어가 부여되었습니다.
*/
	MSG_IG_GUARDIAN_SHIELD_ON = 0xea8,
/*20191204 to latest
가디언 쉴드 효과가 해제되었습니다.
*/
	MSG_IG_GUARDIAN_SHIELD_OFF = 0xea9,
/*20191204 to latest
헌신 효과로 받는 데미지가 감소되었습니다.
*/
	MSG_IG_REBOUND_SHIELD_ON = 0xeaa,
/*20191204 to latest
리바운드 쉴드 효과가 해제되었습니다.
*/
	MSG_IG_REBOUND_SHIELD_OFF = 0xeab,
/*20191204 to latest
성속성 마법 데미지와 암/불사속성 내성이 증가되었습니다. 
*/
	MSG_IG_HOLY_SHIELD_ON = 0xeac,
/*20191204 to latest
홀리 쉴드 효과가 해제되었습니다.
*/
	MSG_IG_HOLY_SHIELD_OFF = 0xead,
/*20191204 to latest
즉시 부활 효과가 부여되었습니다.
*/
	MSG_IG_ULTIMATE_SACRIFICE_ON = 0xeae,
/*20191204 to latest
얼티메이트 세크리파이스 효과가 해제되었습니다.
*/
	MSG_IG_ULTIMATE_SACRIFICE_OFF = 0xeaf,
/*20191204 to latest
특정 스킬의 효능이 변경되었습니다.
*/
	MSG_AG_CLIMAX_ON = 0xeb0,
/*20191204 to latest
클라이막스 효과가 해제되었습니다.
*/
	MSG_AG_CLIMAX_OFF = 0xeb1,
/*20191204 to latest
특정 스킬의 효능이 변경되었습니다.
*/
	MSG_SHC_SHADOW_EXCEED_ON = 0xeb2,
/*20191204 to latest
쉐도우 익시드 효과가 해제되었습니다.
*/
	MSG_SHC_SHADOW_EXCEED_OFF = 0xeb3,
/*20191204 to latest
물리 저항력 무시 효과가 부여되었습니다.
*/
	MSG_SHC_POTENT_VENOM_ON = 0xeb4,
/*20191204 to latest
포텐트 베넘 효과가 해제되었습니다.
*/
	MSG_SHC_POTENT_VENOM_OFF = 0xeb5,
/*20191204 to latest
매 공격 시, 일정 확률로 대상이 받는 데미지를 증가시킵니다.
*/
	MSG_SHC_ENCHANTING_SHADOW_ON = 0xeb6,
/*20191204 to latest
인챈팅 쉐도우 효과가 해제되었습니다.
*/
	MSG_SHC_ENCHANTING_SHADOW_OFF = 0xeb7,
#endif
#if PACKETVER >= 20191211
/*20191211 to latest
토벌 카운트 On
*/
	MSG_HUNTING_QUEST_INFO_ON = 0xeb8,
/*20191211 to latest
토벌 카운트 Off
*/
	MSG_HUNTING_QUEST_INFO_OFF = 0xeb9,
/*20191211 to latest
대상의 AP가 최대치입니다
*/
	MSG_TARGET_AP_MAX = 0xeba,
/*20191211 to latest
...
*/
	MSG_BUY_RECONFIRM2_2019 = 0xebc,
#endif
#if PACKETVER >= 20191218
/*20191218 to latest
서번트 웨폰 %d개가 필요합니다.
*/
	MSG_FAIL_EMPTY_SERVANTWEAPON = 0xebd,
/*20191218 to latest
https://member.gnjoy.com.tw/billing.aspx
*/
	MSG_BILLING_INFO_URL = 0xebe,
#endif
#if PACKETVER >= 20200108
/*20200108 to latest
역순 정렬
*/
	MSG_CHANGE_MATERIAL_INVSORT = 0xebf,
/*20200108 to latest
검색 내용 입력
*/
	MSG_CHANGE_MATERIAL_SEARCHTEXT = 0xec0,
/*20200108 to latest
검색
Search
*/
...
리서치 리포트 상태가 됩니다.
*/
	MSG_BO_RESEARCHREPORT_ON = 0xec2,
/*20200122 to latest
리서치 리포트 상태가 해제됩니다.
*/
	MSG_BO_RESEARCHREPORT_OFF = 0xec3,
/*20200122 to latest
제조에 성공 했습니다.
*/
	MSG_BO_BIONIC_PHARMACY_OK = 0xec4,
/*20200122 to latest
제조에 실패 했습니다.
*/
	MSG_BO_BIONIC_PHARMACY_FAIL = 0xec5,
/*20200122 to latest
쉐도우 장비가 파괴 및 해제에서 보호됩니다.
*/
	MSG_BO_ADVANCE_PROTECTION_ON = 0xec6,
/*20200122 to latest
풀 쉐도우 프로텍션이 해제됩니다.
*/
	MSG_BO_ADVANCE_PROTECTION_OFF = 0xec7,
/*20200122 to latest
식물형, 무형 몬스터에게 주는 데미지가 증가합니다.
*/
	MSG_BO_HELLTREE_ON = 0xec8,
/*20200122 to latest
지옥 나무의 가루효과가 사라집니다.
*/
	MSG_BO_HELLTREE_OFF = 0xec9,
#endif
#if PACKETVER >= 20200129
/*20200129 to latest
공격 장치가 활성화되었습니다.
*/
	MSG_MT_A_MACHINE_ON = 0xeca,
/*20200129 to latest
공격 장치가 해제되었습니다.
*/
	MSG_MT_A_MACHINE_OFF = 0xecb,
/*20200129 to latest
물리 방어력 및 물리 저항력이 증가되었습니다.
*/
	MSG_MT_D_MACHINE_ON = 0xecc,
/*20200129 to latest
방어 장치가 해제되었습니다.
*/
	MSG_MT_D_MACHINE_OFF = 0xecd,
/*20200129 to latest
검색
Search
*/
	MSG_CASHSHOP_TAB_SEARCH = 0xece,
#endif
#if PACKETVER >= 20200212
/*20200212 to latest
합주를 혼자 사용할 수 있습니다.
*/
	MSG_TR_KVASIR_SONATA_ON = 0xecf,
/*20200212 to latest
크바시르의 지혜가 사라집니다.
*/
	MSG_TR_KVASIR_SONATA_OFF = 0xed0,
/*20200212 to latest
미스틱 심포니의 효과가 부여됩니다.
*/
	MSG_TR_MYSTIC_SYMPHONY_ON = 0xed1,
/*20200212 to latest
미스틱 심포니의 효과가 사라집니다.
*/
	MSG_TR_MYSTIC_SYMPHONY_OFF = 0xed2,
/*20200212 to latest
마법 저항력이 감소했습니다.
*/
	MSG_TR_GEF_NOCTURN_ON = 0xed3,
/*20200212 to latest
게페니아 녹턴의 효과가 해제 되었습니다.
*/
	MSG_TR_GEF_NOCTURN_OFF = 0xed4,
/*20200212 to latest
물리 저항력이 감소했습니다.
*/
	MSG_TR_AIN_RHAPSODY_ON = 0xed5,
/*20200212 to latest
마인워커 랩소디 상태가 해제되었습니다.
*/
	MSG_TR_AIN_RHAPSODY_OFF = 0xed6,
/*20200212 to latest
물리 저항력이 증가했습니다.
*/
	MSG_TR_MUSICAL_INTERLUDE_ON = 0xed7,
/*20200212 to latest
뮤지컬 인터루드 상태가 해제되었습니다.
*/
	MSG_TR_MUSICAL_INTERLUDE_OFF = 0xed8,
/*20200212 to latest
특성 마법 공격력과 이동 속도가 증가합니다.
*/
	MSG_TR_JAWAII_SERENADE_ON = 0xed9,
/*20200212 to latest
저녁 노을의 세레나데 효과가 해제되었습니다.
*/
	MSG_TR_JAWAII_SERENADE_OFF = 0xeda,
/*20200212 to latest
특성 물리 공격력과 이동 속도가 증가합니다.
*/
	MSG_TR_PRON_MARCH_ON = 0xedb,
/*20200212 to latest
 프론테라의 행진곡 효과가 해제되었습니다.
*/
	MSG_TR_PRON_MARCH_OFF = 0xedc,
/*20200212 to latest
바람의 분노가 시전자에게 흘러 들어옵니다.
*/
	MSG_WH_CALAMITYGALE_ON = 0xedd,
/*20200212 to latest
캘러미티 가일 상태가 해제되었습니다.
*/
	MSG_WH_CALAMITYGALE_OFF = 0xede,
/*20200212 to latest
바람에 의해 약점과 모습이 드러납니다.
*/
	MSG_WH_WIND_SIGN_ON = 0xedf,
/*20200212 to latest
윈드 사인 효과가 사라집니다.
*/
	MSG_WH_WIND_SIGN_OFF = 0xee0,
#endif
...
EXP: %.1f%% (basic: 100.0%%, %s: %.1f%%)
*/
	MSG_THAI_PERSONALINFO_EXP2 = 0xee1,
/*20200304 to latest
DROP  : %.1f%% ( basic 100.0%% %s %.1f%%)
DROP: %.1f%% (basic: 100.0%%, %s: %.1f%%)
*/
	MSG_THAI_PERSONALINFO_DROP2 = 0xee2,
/*20200304 to latest
DEATH : %.1f%% ( basic 100.0%% %s %.1f%%)
DEATH: %.1f%% (basic: 100.0%%, %s: %.1f%%)
*/
	MSG_THAI_PERSONALINFO_DEATH2 = 0xee3,
#endif
#if PACKETVER >= 20200506
/*20200506 to latest
특성 마법 공격력이 증가되었습니다.
*/
	MSG_EM_SPELL_ENCHANTING_ON = 0xee4,
/*20200506 to latest
스펠 인챈팅 효과가 해제되었습니다.
*/
	MSG_EM_SPELL_ENCHANTING_OFF = 0xee5,
/*20200506 to latest
프롬 디 어비스 효과가 해제되었습니다.
*/
	MSG_ABC_FROM_THE_ABYSS_OFF = 0xee6,
/*20200506 to latest
특성 물리 공격력, 특성 마법 공격력 및 명중률이 증가되었습니다.
*/
	MSG_ABC_ABYSS_SLAYER_ON = 0xee7,
/*20200506 to latest
어비스 슬레이어 효과가 해제되었습니다.
*/
	MSG_ABC_ABYSS_SLAYER_OFF = 0xee8,
#endif
#if PACKETVER >= 20200617
/*20200617 to latest
캐릭터 생성에 제한이 있을 수 있습니다.
*/
	MSG_CHARACTER_MAKING_RESTRICT = 0xee9,
/*20200617 to latest
월드가 포화상태입니다. 다른 월드를 이용해 주세요.
*/
	MSG_BAN_THAI_GGT_RESTRICTED_MAKE_CHAR = 0xeea,
#endif
#if PACKETVER >= 20200701
/*20200701 to latest
채팅차단해제(수신거부해제)
*/
	MSG_UNBLOCK_CHAT = 0xeeb,
/*20200701 to latest
채팅차단(수신거부)
*/
	MSG_BLOCK_CHAT = 0xeec,
#endif
#if PACKETVER >= 20200729
/*20200729 to latest
해당 제련도는 등급 강화가 불가능합니다.
*/
	MSG_GRADE_ENCHANT_REFINING_LEVEL_LACK = 0xeed,
/*20200729 to latest
장비가 파괴되지 않는 상태입니다.
*/
	MSG_GRADE_ENCHANT_ITEM_UNBREAKABLE = 0xeee,
/*20200729 to latest
보조 재료가 적용되어 있지 않습니다. 
강화를 계속 진행 하시겠습니까?
*/
	MSG_GRADE_ENCHANT_ADDITIONAL_SOURCE_NOT_SELECT = 0xeef,
/*20200729 to latest
클라이언트 파일이 변조되었습니다.
*/
	MSG_CHEAT_HASHFILE = 0xef0,
/*20200729 to latest
메시지
*/
	MSG_GUILD_AGIT_TITLE = 0xef1,
#endif
#if PACKETVER >= 20200819
/*20200819 to latest
판매 할 물품의 총합이 가질 수 있는 Zeny의 양을 넘습니다. 
 수량 및 가격 수정 부탁 드립니다.
*/
	MSG_MERCHANTSHOP_TOTA_LOVER_ZENY_ERR = 0xef2,
#endif
#if PACKETVER >= 20200902
/*20200902 to latest
평판 현황
*/
	MSG_REPUTE_WND = 0xef3,
/*20200902 to latest
%u / 1000 P
*/
	MSG_REPUTE_POINT = 0xef4,
/*20200902 to latest
전체
All
*/
	MSG_REPUTE_TOTAL = 0xef5,
/*20200902 to latest
NOW LOADING..
Loading...
*/
	MSG_REPUTE_NOW_LOADING = 0xef6,
#endif
#if PACKETVER >= 20200916
/*20200916 to latest
보조 재료 선택이 초기화 됩니다.
*/
	MSG_GRADE_ENCHANT_ADDITIONAL_SOURCE_RESET = 0xef7,
/*20200916 to 20201223
인챈트 하기
20201223 to latest
...
*/
	MSG_ENCHANT = 0xef8,
/*20200916 to 20201021
인챈트 초기화
20201104 to latest
일반
General
*/
	MSG_ENCHANT_TAB_GENERAL = 0xef9,
/*20200916 to 20201021
대상 장비의 인챈트를
초기화 하시겠습니까?
비용 : %uZeny
...
성장
*/
	MSG_ENCHANT_TAB_UPGRADE = 0xefb,
/*20200916 to 20201021
잠시 후 재시도 해주세요.
20201104 to latest
초기화
*/
	MSG_ENCHANT_TAB_RESET = 0xefc,
/*20200916 to 20201223
해당 인챈트가 적용될 수 없는 아이템입니다.
20201223 to 20201228

Current admission application state.
20210203 to latest
무게가 70% 이상입니다. 무게를 줄인 후 재시도 해주세요.
*/
	MSG_ENCHANT_FAILED_OVER_WEIGHT = 0xefd,
/*20200916 to 20201223
리스트 중 1개 부여
20201223 to latest
인챈트 부여
*/
	MSG_ENCHANT_RANDOM_BUTTON = 0xefe,
/*20200916 to 20201223
업그레이드
20201223 to latest
인챈트 부여
*/
	MSG_ENCHANT_PERFECT_BUTTON = 0xeff,
/*20200916 to 20201223
확정 인챈트
20201223 to latest
성장
*/
	MSG_ENCHANT_UPGRADE_BUTTON = 0xf00,
/*20200916 to 20201021
%u Zeny
20201104 to 20201223
%I64u Zeny
20201223 to latest
초기화
*/
	MSG_ENCHANT_RESET_BUTTON = 0xf01,
/*20200916 to latest
인챈트 중에는 로덱스를 사용할 수 없습니다. 로덱스를 강제 종료하였습니다.
*/
	MSG_CLOSE_RODEX_FOR_ENCHANT = 0xf02,
/*20200916 to latest
인챈트 중에는 로덱스를 사용할 수 없습니다.
*/
	MSG_CANNOT_OPEN_RODEX_DURING_ENCHANT = 0xf03,
/*20200916 to latest
인챈트 중에는 은행을 사용할 수 없습니다. 은행을 강제 종료하였습니다.
*/
	MSG_CLOSE_BANKING_FOR_ENCHANT = 0xf04,
/*20200916 to latest
인챈트 중에는 은행을 사용할 수 없습니다.
*/
	MSG_CANNOT_OPEN_BANKING_DURING_ENCHANT = 0xf05,
/*20200916 to latest
인챈트를 실행하시겠습니까?
*/
	MSG_ENCHANT_REQUEST = 0xf06,
/*20200916 to latest
제작
*/
	MSG_ITEM_REFORM_OK = 0xf07,
/*20200916 to latest
조합에 필요한 재료가 부족합니다.
*/
	MSG_ITEM_REFORM_WARNNING_NOT_ENOUGH_MATERIAL = 0xf08,
/*20200916 to latest
장착된 카드 아이템과 부여된 인챈트가 소실됩니다.
*/
	MSG_ITEM_REFORM_WARNNING_CARD_ENCHANT_LOST = 0xf09,
/*20200916 to latest
장착된 카드 아이템이 소실될 수 있습니다.
*/
	MSG_ITEM_REFORM_WARNNING_CARD_MAYBE_LOST = 0xf0a,
/*20200916 to latest
부여된 인챈트가 소실될 수 있습니다.
*/
	MSG_ITEM_REFORM_WARNNING_ENCHANT_MAYBE_LOST = 0xf0b,
#endif
#if PACKETVER >= 20200923
/*20200923 to latest
화면 내 유저 숨기기 ON
*/
	MSG_HIDE_PLAYER_ON = 0xf0c,
/*20200923 to latest
화면 내 유저 숨기기 OFF
*/
	MSG_HIDE_PLAYER_OFF = 0xf0d,
#endif
#if PACKETVER >= 20201021
/*20201021 to latest
세부 내용 확인
*/
	MSG_ITEM_REFORM_CONFIRM_DETAILS = 0xf0e,
/*20201021 to latest
세부 내용을 확인해주세요.
*/
	MSG_ITEM_REFORM_PLZ_CHECK_DETAILS = 0xf0f,
#endif
#if PACKETVER >= 20201104
/*20201104 to latest
조합 가능한 아이템이 없습니다.
*/
	MSG_ITEM_REFORM_NO_EXIST_TARGET_ITEM = 0xf10,
#endif
#if PACKETVER >= 20201118
/*20201118 to latest
인챈트 성공!
*/
	MSG_ENCHANT_SUCCESS = 0xf11,
/*20201118 to latest
인챈트 실패!
*/
	MSG_ENCHANT_FAILED = 0xf12,
/*20201118 to latest
인챈트 정보를 찾을 수 없습니다
*/
	MSG_CANNOT_FIND_ENCHANT_ID = 0xf13,
/*20201118 to latest
인챈트 조건을 만족하지 않습니다.
*/
	MSG_NOT_SATISFIED_ENCHANT_CONDITION = 0xf14,
/*20201118 to latest
임의 유저 수신 여부 설정 실패.
*/
	MSG_RODEX_SPAMOPTION_FAIL = 0xf15,
/*20201118 to latest
임의 유저 수신 거부 상태로 설정 되었습니다.
*/
	MSG_RODEX_SPAMOPTION_ON = 0xf16,
/*20201118 to latest
모든 유저 수신 상태로 설정 되었습니다.
*/
	MSG_RODEX_SPAMOPTION_OFF = 0xf17,
/*20201118 to latest
%s님이 수신 거부 상태 입니다.
*/
	MSG_RODEX_SPAMOPTION_USERBLOCK = 0xf18,
/*20201118 to 20201118
매일이 반송 되었습니다.
20201201 to latest
RODEX가 반송 되었습니다.
*/
	MSG_RODEX_SPAMOPTION_RETURN_SUCCESS = 0xf19,
/*20201118 to 20201118
매일 반송에 실패 하였습니다.
20201201 to latest
RODEX 반송에 실패 하였습니다.
*/
	MSG_RODEX_SPAMOPTION_RETURN_FAIL = 0xf1a,
/*20201118 to latest
해당 RODEX의 발신자는 친구 및 길드원이 아닙니다.주의 해주세요.
*/
	MSG_RODEX_SPAMOPTION_WARNING = 0xf1b,
/*20201118 to latest
RODEX 모든 유저 수신
*/
	MSG_RODEX_SPAMOPTION = 0xf1c,
/*20201118 to latest
동일한 효과의 지속 시간이 한도를 초과하여 사용이 불가능합니다.
*/
	MSG_EFST_ITEM_TIME_LIMIT_EXCEED = 0xf1d,
#endif
#if PACKETVER >= 20201201
/*20201201 to latest
성공 시 제련도는 0으로 초기화됩니다!
*/
	MSG_GRADE_ENCHANT_SUCCESS_REFINING_LEVEL_DISAPPEAR = 0xf1e,
/*20201201 to latest
카드, 랜덤옵션, 인챈트는 유지됩니다.
*/
	MSG_GRADE_ENCHANT_SUCCESS_RANDOM_OPT_ENCHANT_KEEP = 0xf1f,
/*20201201 to latest
실패 시 제련도는 유지됩니다.
*/
	MSG_GRADE_ENCHANT_FAILED_REFINING_RANDOM_OPT_ENCHANT_KEEP = 0xf20,
/*20201201 to latest
초기화
*/
	MSG_HOTKEY_RESET = 0xf21,
/*20201201 to latest
구버전
*/
	MSG_HOTKEY_OLD_VER = 0xf22,
#endif
#if PACKETVER >= 20210203
/*20210203 to latest
Base Lv. %d
*/
	MSG_EXP_BAR_BASE_LV = 0xf23,
/*20210203 to latest
Job Lv. %d
*/
	MSG_EXP_BAR_JOB_LV = 0xf24,
/*20210203 to latest
Lv.%d %s
*/
	MSG_BASIC_INFO_LV_NAME = 0xf25,
/*20210203 to latest
퀘스트목록
*/
	MSG_MENU_ICON_QUEST = 0xf26,
/*20210203 to latest
캐시상점
*/
	MSG_MENU_ICON_CASHSHOP = 0xf27,
/*20210203 to latest
단축키안내
*/
	MSG_MENU_ICON_HOTKEY = 0xf28,
/*20210203 to latest
모험가중개소
*/
	MSG_MENU_ICON_ADVENTURER_AGENCY = 0xf29,
#endif
#if PACKETVER >= 20210217
/*20210217 to 20210217
New UI
20210303 to latest
UI 테마
*/
	MSG_NEWUI_ZERO_ONOFF = 0xf2a,
#endif
#if PACKETVER >= 20210303
/*20210303 to latest
기존 UI
*/
	MSG_NEWUI_ZERO_UIOLD = 0xf2b,
/*20210303 to latest
신규 UI
*/
	MSG_NEWUI_ZERO_UINEW = 0xf2c,
/*20210303 to latest
UI 스킨
*/
	MSG_NEWUI_ZERO_UISKIN = 0xf2d,
#endif
#if PACKETVER >= 20210331
/*20210331 to 20220302
- 신규 옵션 -
20220316 to latest
- 추가 옵션 -
*/
	MSG_NEW_RANDOM_OPTION = 0xf2e,
#endif
#if PACKETVER >= 20210504
/*20210504 to latest
무형
Formless
*/
...
/*20210602 to 20210616
- 퀘스트 종류 : 노멀 / 일일 / 지역 / 이벤트 / 에피소드 / 직업 / 가이드 퀘스트로 분류하여 정렬합니다.
20210630 to latest
...
/*20210602 to 20210616
- 정렬한 퀘스트 내용에서 원하는 내용을 검색하여 좀 더 세분화된 검색을 할 수 있습니다.
20210630 to latest
...
/*20210602 to 20210616
- 퀘스트 상세 설명의 텍스트 하이퍼링크 또는 npc(몬스터)이미지 클릭 시 :
20210630 to latest
...
/*20220216 to latest
수면, 석화 상태에서는 아이템을 사용 할 수 없습니다.
*/
	MSG_PACKAGEITEM_SLEEPSTONECURSEFAIL = 0xf82,
/*20220216 to latest
Burrow 상태에서는 아이템을 사용 할 수 없습니다.
*/
	MSG_PACKAGEITEM_BURROWFAIL = 0xf83,
/*20220216 to latest
패키지 아이템 사용 할 수 없는 상태 입니다.
*/
	MSG_PACKAGEITEM_USEFAIL = 0xf84,
/*20220216 to latest
패키지 아이템 셋팅 실패!!
*/
	MSG_PACKAGEITEM_SETTINGFAIL = 0xf85,
/*20220216 to latest
^ff0000 %d일 %d시간 동안 사용 가능 ^000000
*/
	MSG_PACKAGEITEM_TIME = 0xf86,
/*20220216 to 20220420
%s 를 선택 하셨습니다.  선택한 내용이 맞습니까?
20220504 to latest
%s(을)를 선택하셨습니다. 선택한 내용이 맞습니까?
*/
	MSG_PACKAGEITEM_SELECT = 0xf87,
#endif
#if PACKETVER >= 20220302
/*20220302 to latest
1회당 요구 수량 : %d개
*/
	MSG_GRADE_ENCHANT_ENHANCED_UP = 0xf88,
/*20220302 to latest
Imperial Guard
*/
	MSG_JOB_IMPERIAL_GUARD = 0xf89,
/*20220302 to latest
Abyss Chaser
*/
	MSG_JOB_ABYSS_CHASER = 0xf8a,
/*20220302 to latest
Windhawk
*/
	MSG_JOB_WINDHAWK = 0xf8b,
/*20220302 to latest
엠블렘 등록에 실패하였습니다.
*/
	MSG_EMBLEM_UPLOAD_FAILED_DB = 0xf8c,
/*20220302 to latest
서버 등록에 실패하였습니다.
*/
	MSG_EMBLEM_UPLOAD_FAILED_AUTH = 0xf8d,
/*20220302 to latest
파일 등록에 실패 하였습니다.
*/
	MSG_EMBLEM_UPLOAD_FAILED_FILE = 0xf8e,
#endif
#if PACKETVER >= 20220330
/*20220330 to latest
미니파티창 정렬
*/
	MSG_SORT_MINIPARTY = 0xf8f,
/*20220330 to latest
균등분배 상태입니다.
파티원의 무게 또는 종류가 초과하여 아이템을 획득할 수 없습니다.
*/
	MSG_PICKUP_FAILED_PARTY_MEMBER = 0xf90,
#endif
#if PACKETVER >= 20220518
/*20220518 to latest
[%s]님이 [%s](으)로부터 '+%d %s' 를 획득 했습니다.
*/
	MSG_BROADCASTING_SPECIAL_ITEM_OBTAIN_ADD_LEVEL = 0xf91,
/*20220518 to latest
우편함을 다시 열어주세요.
*/
	MSG_FAILED_ALL_RODEX_LIST = 0xf92,
#endif
#if PACKETVER >= 20220629
/*20220629 to latest
현재의 직업에서는 호문클루스S를 소환할 수 없습니다. 상위 직업으로의 전직이 필요합니다.
*/
	MSG_FAIL_CALLHOMUN_INVALID_JOBTYPE = 0xf93,
/*20220629 to latest
카드를 장착할 수 있는 장비 아이템이 없습니다.
*/
	MSG_FAIL_ITEMCOMPOSITION_LIST = 0xf94,
#endif
...
*/
	MSG_ID_FA0 = 0xfa0,
/*20220803 to latest
^0054FF[능력치보정] % d.%d %%^000000
*/
	MSG_ID_FA1 = 0xfa1,
#endif
#if PACKETVER >= 20220817
/*20220817 to latest
더 이상 NPC를 호출할 수 없습니다.
*/
	MSG_ID_FA2 = 0xfa2,
#endif
#if PACKETVER >= 20220831
/*20220831 to latest
%d회 오류시 운영정책에 의거하여 영구블록됩니다.
*/
	MSG_ID_FA3 = 0xfa3,
#endif
#if PACKETVER >= 20220921
/*20220921 to latest
현재의 직업에서는 소환할 수 없습니다. 상위 직업으로의 전직이 필요합니다.
*/
	MSG_ID_FA4 = 0xfa4,
#endif
#if PACKETVER >= 20221019
/*20221019 to latest
마도 기어 탑승자에게는 스트립 계열 스킬을 사용할 수 없습니다.
*/
	MSG_ID_FA5 = 0xfa5,
#endif
