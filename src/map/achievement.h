...
struct achievement_interface {
	...
	/* */
	bool (*readdb_validate_criteria_mobid) (const struct config_setting_t *t, struct achievement_objective *obj, enum achievement_types type, const int entry_id, const int obj_idx);
	bool (*readdb_validate_criteria_jobid) (const struct config_setting_t *t, struct achievement_objective *obj, enum achievement_types type, const int entry_id, const int obj_idx);
	bool (*readdb_validate_criteria_itemid) (const struct config_setting_t *t, struct achievement_objective *obj, enum achievement_types type, const int entry_id, const int obj_idx);
	bool (*readdb_validate_criteria_statustype) (const struct config_setting_t *t, struct achievement_objective *obj, enum achievement_types type, const int entry_id, const int obj_idx);
	bool (*readdb_validate_criteria_itemtype) (const struct config_setting_t *t, struct achievement_objective *obj, enum achievement_types type, const int entry_id, const int obj_idx);
	bool (*readdb_validate_criteria_weaponlv) (const struct config_setting_t *t, struct achievement_objective *obj, enum achievement_types type, const int entry_id, const int obj_idx);
	bool (*readdb_validate_criteria_achievement) (const struct config_setting_t *t, struct achievement_objective *obj, enum achievement_types type, const int entry_id, const int obj_idx);
	/* */
	...
	void (*progress_add) (struct map_session_data *sd, struct achievement_data *ad, const unsigned int obj_idx, const int progress);
	void (*progress_set) (struct map_session_data *sd, struct achievement_data *ad, const unsigned int obj_idx, const int progress);
	bool (*check_criteria) (const struct achievement_objective *objective, const struct achievement_objective *criteria);
	/* */
	bool (*validate) (struct map_session_data *sd, const int aid, const unsigned int obj_idx, const int progress, bool additive);
	int (*validate_type) (struct map_session_data *sd, const enum achievement_types type, const struct achievement_objective *criteria, const int progress, bool additive);
	/* */
	...
	void (*validate_refine) (struct map_session_data *sd, const unsigned int idx, bool success);
	...
	void (*validate_achievement_rank) (struct map_session_data *sd, const int rank);
	/* */
