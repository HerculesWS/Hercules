...
enum unique_criteria_types { CRITERIA_UNIQUE_NONE, CRITERIA_UNIQUE_ACHIEVE_ID, CRITERIA_UNIQUE_ITEM_ID, CRITERIA_UNIQUE_STATUS_TYPE, CRITERIA_UNIQUE_WEAPON_LV };
...
#define achievement_criteria_mobid(t) ((t) == ACH_KILL_MOB_CLASS || (t) == ACH_PET_CREATE)

// Achievements types that use JobID vector as criteria.
#define achievement_criteria_jobid(t) ((t) == ACH_KILL_PC_JOB || (t) == ACH_KILL_PC_JOBTYPE || (t) == ACH_JOB_CHANGE || (t) == ACH_STATUS_BY_JOB || (t) == ACH_STATUS_BY_JOBTYPE)

// Achievements types that use Item ID as criteria.
#define achievement_criteria_itemid(t) ((t) == ACH_ITEM_GET_COUNT || (t) == ACH_EQUIP_REFINE_SUCCESS_ID || (t) == ACH_EQUIP_REFINE_FAILURE_ID)

// Achievements types that use status type parameter as criteria.
#define achievement_criteria_stattype(t) ((t) == ACH_STATUS || (t) == ACH_STATUS_BY_JOB || (t) == ACH_STATUS_BY_JOBTYPE)

// Achievements types that use item type mask as criteria.
#define achievement_criteria_itemtype(t) ((t) == ACH_ITEM_GET_COUNT_ITEMTYPE)

// Achievements types that use weapon level as criteria.
#define achievement_criteria_weaponlv(t) ((t) == ACH_EQUIP_REFINE_SUCCESS_WLV || (t) == ACH_EQUIP_REFINE_FAILURE_WLV)

// Valid status types for objective criteria.
#define achievement_valid_status_types(s) ((s) == SP_STR || (s) == SP_AGI || (s) == SP_VIT || (s) == SP_INT || (s) == SP_DEX || (s) == SP_LUK || (s) == SP_BASELEVEL || (s) == SP_JOBLEVEL)
