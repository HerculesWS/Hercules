...
void guild_makemember(struct guild_member *m,struct map_session_data *sd)
{
	...
	m->login_date = (int)time(NULL); // When player create or join a guild the date is updated
	return;
}
...
int guild_recv_memberinfoshort(int guild_id, int account_id, int char_id, int online, int lv, int16 class, uint32 login_date)
{ // cleaned up [LuzZza]
