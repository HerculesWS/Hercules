 ...
 **/
enum private_airship { P_AIRSHIP_NONE, P_AIRSHIP_RETRY, P_AIRSHIP_ITEM_NOT_ENOUGH, P_AIRSHIP_INVALID_END_MAP, P_AIRSHIP_INVALID_START_MAP, P_AIRSHIP_ITEM_INVALID };
...
enum siege_teleport_result { SIEGE_TP_SUCCESS = 0x0, SIEGE_TP_NOT_ENOUGH_ZENY = 0x1, SIEGE_TP_INVALID_MODE = 0x2 };

/** Client action types */
enum action_type { ACT_ATTACK, ACT_ITEMPICKUP, ACT_SIT, ACT_STAND, ACT_ATTACK_NOMOTION, ACT_SPLASH, ACT_SKILL, ACT_ATTACK_REPEAT, ACT_ATTACK_MULTIPLE, ACT_ATTACK_MULTIPLE_NOMOTION, ACT_ATTACK_CRITICAL, ACT_ATTACK_LUCKY, ACT_TOUCHSKILL, ACT_ATTACK_MULTIPLE_CRITICAL, ACT_SPLASH_NOMOTION };

enum unequip_all { TAKEOFF_EQUIP_ALL_SUCCESS = 0, TAKEOFF_EQUIP_ALL_FAILED = 1 };
 ...
 **/
enum stylist_shop { STYLIST_SHOP_SUCCESS, STYLIST_SHOP_FAILURE };

enum memorial_dungeon_command {
	COMMAND_MEMORIALDUNGEON_DESTROY_FORCE = 0x3,
};

enum expand_inventory { EXPAND_INVENTORY_ASK_CONFIRMATION = 0, EXPAND_INVENTORY_FAILED = 1, EXPAND_INVENTORY_OTHER_WORK = 2, EXPAND_INVENTORY_MISSING_ITEM = 3, EXPAND_INVENTORY_MAX_SIZE = 4 };

enum expand_inventory_result { EXPAND_INVENTORY_RESULT_SUCCESS = 0, EXPAND_INVENTORY_RESULT_FAILED = 1, EXPAND_INVENTORY_RESULT_OTHER_WORK = 2, EXPAND_INVENTORY_RESULT_MISSING_ITEM = 3, EXPAND_INVENTORY_RESULT_MAX_SIZE = 4 };
...
#else
enum market_buy_result { MARKET_BUY_RESULT_ERROR = 0, MARKET_BUY_RESULT_SUCCESS = 1, MARKET_BUY_RESULT_NO_ZENY = 0, MARKET_BUY_RESULT_OVER_WEIGHT = 0, MARKET_BUY_RESULT_OUT_OF_SPACE = 0, MARKET_BUY_RESULT_AMOUNT_TOO_BIG = 0 };
#endif
...
enum lapineUpgrade_result { LAPINE_UPGRADE_SUCCESS = 0, LAPINE_UPGRADE_FAILED = 1 };
