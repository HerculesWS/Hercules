...
{
	const struct PACKET_CHARLOGIN_SET_ACCOUNT_ONLINE *p = RFIFOP(struct PACKET_CHARLOGIN_SET_ACCOUNT_ONLINE *, fd, 0);
...
static void login_fromchar_parse_online_accounts(int fd, int id)
{
	...
	const struct PACKET_CHARLOGIN_ONLINE_ACCOUNTS *p = RFIFOP(struct PACKET_CHARLOGIN_ONLINE_ACCOUNTS *, fd, 0);
