...
struct inter_interface {
	...
	void (*vmsg_to_fd)(int fd, int u_fd, int aid, const char *msg, va_list ap)
	    __attribute__((format(printf, 4, 0)));
	void (*msg_to_fd)(int fd, int u_fd, int aid, const char *msg, ...) __attribute__((format(printf, 4, 5)));
	...
	void (*accinfo2)(
	    bool success, int map_fd, int u_fd, int u_aid, int account_id, const char *userid, const char *user_pass,
