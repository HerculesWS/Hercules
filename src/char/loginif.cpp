...
static void do_init_loginif(void)
{
	...
	timer->add_interval(
	    timer->gettick() + 1000, chr->send_accounts_tologin, 0, 0, 3600 * 1000
...
static void
    loginif_ban_account(int account_id, short year, short month, short day, short hour, short minute, short second)
{
	Assert_retv(chr->login_fd != -1);
