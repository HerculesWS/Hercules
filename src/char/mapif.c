...
{
	const struct PACKET_MAPCHAR_GUILD_EMBLEM *p = RFIFOP(struct PACKET_MAPCHAR_GUILD_EMBLEM *, fd, 0);
...
static void mapif_agency_joinPartyResult(int fd, int char_id, enum adventurer_agency_result result)
{
	...
	struct PACKET_CHARMAP_AGENCY_JOIN_PARTY *p = WFIFOP(struct PACKET_CHARMAP_AGENCY_JOIN_PARTY *, fd, 0);
