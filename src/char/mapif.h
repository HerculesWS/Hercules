...
struct mapif_interface {
	...
	int (*guild_alliance)(
	    int guild_id1, int guild_id2, int account_id1, int account_id2, int flag, const char *name1,
	    const char *name2
	);
	...
	int (*parse_GuildChangeMemberInfoShort)(
	    int fd, int guild_id, int account_id, int char_id, int online, int lv, int class_
	);
	...
	int (*parse_GuildMemberInfoChange)(
	    int fd, int guild_id, int account_id, int char_id, int type, const char *data, int len
	);
	...
	int (*parse_PartyChangeMap)(
	    int fd, int party_id, int account_id, int char_id, unsigned short map, int online, unsigned int lv
	);
	...
	void (*rodex_sendinbox)(
	    int fd, int char_id, int8 opentype, int8 flag, int count, int64 mail_id, struct rodex_maillist *mails
	);
	...
	void (*rodex_checkname)(
	    int fd, int reqchar_id, int target_char_id, int target_class, int target_level, char *name
	);
	void (*rodex_getzenyack)(int char_id, int64 mail_id, uint8 opentype, int64 zeny);
	void (*rodex_getitemsack)(
	    int char_id, int64 mail_id, uint8 opentype, int count, const struct rodex_item *items
	);
