...
/** Assert */
   ...
   */
  #define Assert_chk(EX) \
	  ((EX) ? false : (nullpo->assert_report(__FILE__, __LINE__, __func__, #EX, "failed assertion"), true))
  /**
   ...
   */
  #define nullpo_chk(t) \
	  ((t) != NULL ? false : (nullpo->assert_report(__FILE__, __LINE__, __func__, #t, "nullpo info"), true))
#else // ! NULLPO_CHECK
