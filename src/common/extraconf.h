...
struct extraconf_interface {
	...
	bool (*read_conf_file)(
	    const char *filename, bool imported, const char *node, const struct config_data *conf_vars
	);
	bool (*read_conf)(
	    const char *filename, bool imported, struct config_t *config, const char *node,
	...
	bool (*set_var)(const struct config_data *conf_var, int val);
	bool (*set_var_str)(const struct config_data *conf_var, const char *val);
