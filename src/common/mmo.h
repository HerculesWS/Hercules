...
#endif
#ifndef MAX_SKILL_DB
#define MAX_SKILL_DB 1336 ///< Maximum number of skills in the skill DB (compacted array size)
#endif
#ifndef MAX_SKILL_ID
...
enum e_class {
	...
	JOB_RUNE_KNIGHT3 = 4088,
	JOB_RUNE_KNIGHT4 = 4089,
	JOB_RUNE_KNIGHT5 = 4090,
	JOB_RUNE_KNIGHT6 = 4091,
	JOB_RUNE_KNIGHT7 = 4092,
	JOB_RUNE_KNIGHT8 = 4093,
	JOB_RUNE_KNIGHT9 = 4094,
	JOB_RUNE_KNIGHT10 = 4095,
	...
	JOB_BADY_STAR_EMPEROR = 4241,
	JOB_BABY_SOUL_REAPER = 4242,

	// JOB_2004_JOB_LAST = 4249,
