...
#define WFIFO_CHUNKED_BLOCK_END_RAW() WFIFOSET(p##_fd, p##_len)
...
#define WFIFO_CHUNKED_FINAL_START_RAW_FLAG(p) ((p)->flag = 2)

#define WFIFO_CHUNKED_FINAL_END_RAW() WFIFOSET(p##_fd, p##_len)
...
#define WFIFO_CHUNKED_BLOCK_END() WFIFO_CHUNKED_BLOCK_END_RAW()
...
#define WFIFO_CHUNKED_FINAL_END() WFIFO_CHUNKED_FINAL_END_RAW()
...
#define WFIFO_CLIENT_CHUNKED_BLOCK_END() WFIFO_CHUNKED_BLOCK_END_RAW()

#define WFIFO_CLIENT_CHUNKED_FINAL_START(p, _dataField) \
	WFIFO_CHUNKED_FINAL_START_RAW1(p, _dataField, WFIFO_CLIENT_CHUNK_SIZE)

#define WFIFO_CLIENT_CHUNKED_FINAL_END() WFIFO_CHUNKED_FINAL_END_RAW()
