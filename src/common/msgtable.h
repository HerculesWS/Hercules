...
enum msgtable_messages {
	...
	/** Can't apply: not enough members in your team/guild that have not entered the queue in individual mode,
	 * minimum is %d Note: in this case, your guild does have enough members, but some of them are not available to
	 * join now
	 */
	...
	/** Can't apply: not enough members in your team/party that have not entered the queue in individual mode,
	 * minimum is %d Note: in this case, your party does have enough members, but some of them are not available to
	 * join now
	 */
	 ...
	 * This differs from MSGTBL_DAY_MODE_ACTIVATED as MSGTBL_DAY_MODE_ACTIVATED2 is used when "natural" change
	 * happens, while MSGTBL_DAY_MODE_ACTIVATED is triggered by GM command
	 */
	MSGTBL_DAY_MODE_ACTIVATED2   = 502,
	/** Night Mode is activated.
	 * This differs from MSGTBL_NIGHT_MODE_ACTIVATED as MSGTBL_NIGHT_MODE_ACTIVATED2 is used when "natural" change
	 * happens, while MSGTBL_NIGHT_MODE_ACTIVATED is triggered by GM command
	 */
	...
	/** File unloaded. Be aware that some changes made by NPC are not reverted on unload. See doc/atcommands.txt for
	 * details. */
	...
	/** Type List: (default) all = -1, healing = 0, usable = 2, etc = 3, weapon = 4, armor = 5, card = 6, petegg =
	 * 7, petarmor = 8, ammo = 10, delayed-consumable = 11, cash = 18 */
