...
#define bin2hex(output, input, count) (strlib->bin2hex_((output), (input), (count)))
	...
	// _Generic is only supported starting with GCC 4.9
			...
			#undef strchr
		#endif // strchr
		#define strchr(src, chr) _Generic((src), const char *: ((const char *)(strchr)((src), (chr))), char *: ((strchr)((src), (chr))))
		#define strrchr(src, chr) _Generic((src), const char *: ((const char *)(strrchr)((src), (chr))), char *: ((strrchr)((src), (chr))))
		#define strstr(haystack, needle) _Generic((haystack), const char *: ((const char *)(strstr)((haystack), (needle))), char *: ((strstr)((haystack), (needle))))
	#endif
#endif
