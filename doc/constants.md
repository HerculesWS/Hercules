...
## Table of contents
#### 1. [Constants (db/constants.conf)](#constants-dbconstantsconf)
- [Weekdays](#weekdays)
- [Months](#months)
- [Job IDs](#job-ids)
- [Job masks / Job map_ids](#job-masks--job-map_ids)
- [Broadcast flags](#broadcast-flags)
- [Mapflags](#mapflags)
- [Cell Properties](#cell-properties)
- [Cell checks](#cell-checks)
- [Bonuses / Parameter IDs](#bonuses--parameter-ids)
...
- [Attack Flags](#attack-flags)
- [Status Changes](#status-changes)
- [Emotes](#emotes)
- [petstat](#petstat)
- [getmonsterinfo](#getmonsterinfo)
- [mercenary guilds](#mercenary-guilds)
- [Effects](#effects)
- [NPC sprite IDs](#npc-sprite-ids)
- [Mercenary IDs](#mercenary-ids)
- [checkquest](#checkquest)
- [questinfo](#questinfo)
- [Font weight](#font-weight)
- [old setlook (use LOOK_* constants instead)](#old-setlook-use-look_-constants-instead)
- [Directions](#directions)
- [Item types](#item-types)
- [queueopt](#queueopt)
- [Instance owner type](#instance-owner-type)
- [tradertype](#tradertype)
- [strcharinfo](#strcharinfo)
- [strnpcinfo](#strnpcinfo)
- [getcharid](#getcharid)
- [sc_start](#sc_start)
- [Mount types](#mount-types)
- [Gettime Types](#gettime-types)
- [gettimer](#gettimer)
- [unit types](#unit-types)
- [Unit AI Types](#unit-ai-types)
- [Colors](#colors)
- [Genders](#genders)
- [Script Unit Data Types](#script-unit-data-types)

#### 2. [Hardcoded Constants (source)](#hardcoded-constants-source)
- [Boolean](#boolean)
- [Server defines](#server-defines)
- [status options](#status-options)
- [status option compounds](#status-option-compounds)
- [send_target](#send_target)
- [LOOK_ constants, use in setlook/changelook script commands](#look_-constants-use-in-setlookchangelook-script-commands)
- [Equip Position in Bits,  use with *getiteminfo type 5, or @inventorylist_equip](#equip-position-in-bits--use-with-getiteminfo-type-5-or-inventorylist_equip)
- [Item Option Types](#item-option-types)
- [Maximum Item Options](#maximum-item-options)
- [Navigation constants, use with *navigateto*](#navigation-constants-use-with-navigateto)
- [BL types](#bl-types)
- [Refine Chance Types](#refine-chance-types)
- [Player permissions](#player-permissions)
- [Data types](#data-types)
- [Logmes types](#logmes-types)
- [Item Subtypes (Weapon types)](#item-subtypes-weapon-types)
- [Item Subtypes (Ammunition types)](#item-subtypes-ammunition-types)
- [Item Upper Masks](#item-upper-masks)
- [dressroom modes](#dressroom-modes)
...
#### 4. [Skills (db/re/skill_db.txt)](#skills-dbreskill_dbtxt)
