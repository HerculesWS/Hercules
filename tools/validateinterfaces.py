...
ignoreMethods = (
    ...
    "map_zone_mf_get_nomemo",
    "map_zone_mf_get_noteleport",
    "map_zone_mf_get_nobranch",
    "map_zone_mf_get_nozenypenalty",
    "map_zone_mf_get_pvp",
    "map_zone_mf_get_pvp_noparty",
    "map_zone_mf_get_pvp_noguild",
    "map_zone_mf_get_gvg",
    "map_zone_mf_get_gvg_noparty",
    "map_zone_mf_get_notrade",
    "map_zone_mf_get_noskill",
    "map_zone_mf_get_nowarp",
    "map_zone_mf_get_partylock",
    "map_zone_mf_get_noicewall",
    "map_zone_mf_get_snow",
    "map_zone_mf_get_fog",
    "map_zone_mf_get_sakura",
    "map_zone_mf_get_leaves",
    "map_zone_mf_get_clouds",
    "map_zone_mf_get_clouds2",
    "map_zone_mf_get_fireworks",
    "map_zone_mf_get_gvg_castle",
    "map_zone_mf_get_gvg_dungeon",
    "map_zone_mf_get_nightenabled",
    "map_zone_mf_get_nobaseexp",
    "map_zone_mf_get_nojobexp",
    "map_zone_mf_get_nomobloot",
    "map_zone_mf_get_nomvploot",
    "map_zone_mf_get_noreturn",
    "map_zone_mf_get_nowarpto",
    "map_zone_mf_get_pvp_nightmaredrop",
    "map_zone_mf_get_nodrop",
    "map_zone_mf_get_novending",
    "map_zone_mf_get_loadevent",
    "map_zone_mf_get_nochat",
    "map_zone_mf_get_noexppenalty",
    "map_zone_mf_get_guildlock",
    "map_zone_mf_get_town",
    "map_zone_mf_get_autotrade",
    "map_zone_mf_get_allowks",
    "map_zone_mf_get_monster_noteleport",
    "map_zone_mf_get_pvp_nocalcrank",
    "map_zone_mf_get_battleground",
    "map_zone_mf_get_cvc",
    "map_zone_mf_get_reset",
    "map_zone_mf_get_notomb",
    "map_zone_mf_get_nocashshop",
    "map_zone_mf_get_noautoloot",
    "map_zone_mf_get_pairship_startable",
    "map_zone_mf_get_pairship_endable",
    "map_zone_mf_get_chsysnolocalaj",
    "map_zone_mf_get_noknockback",
    "map_zone_mf_get_src4instance",
    "map_zone_mf_get_nosendmail",
